...
Return the complete code with explanations.`;
        ...
        const response = await this.client.generateStructuredContent(prompt, responseSchema, { thinkingLevel: 'high', tools: { codeExecution: true } });
        return {

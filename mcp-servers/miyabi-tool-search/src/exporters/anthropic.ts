 ...
 */
export function exportForAnthropicAPI(
  catalog: ToolCatalog,
  options: {
 ...
 */
function convertToAnthropicTool(
 ...
 */
export function exportForMCPToolset(
  catalog: ToolCatalog
): Record<string, MCPToolsetConfig> {
  const toolsets: Record<string, MCPToolsetConfig> = {};
 ...
 */
export function calculateTokenSavings(catalog: ToolCatalog): {
  ...
  const withDeferLoading =
    alwaysLoadedCount * TOKENS_PER_TOOL + TOKENS_FOR_SEARCH_TOOL;
 ...
 */
export function generatePythonExample(catalog: ToolCatalog): string {
 ...
 */
export function generateTypeScriptExample(catalog: ToolCatalog): string {

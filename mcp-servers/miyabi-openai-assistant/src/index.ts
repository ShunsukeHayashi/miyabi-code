 ...
 */
async function generateCode(prompt: string, language?: string, context?: string): Promise<string> {
 ...
 * Tool 2: Explain code
 */
async function explainCode(code: string, language?: string, context?: string): Promise<string> {
 ...
 * Tool 3: Review code
 */
async function reviewCode(code: string, language?: string, focus?: string): Promise<string> {
 ...
 */
async function refactorCode(code: string, language?: string, context?: string): Promise<string> {
 ...
 * Tool 5: Fix bugs
 */
async function fixCode(code: string, error: string, language?: string): Promise<string> {
 ...
 */
async function generateTests(code: string, language?: string, context?: string): Promise<string> {
 ...
 */
async function generateDocumentation(code: string, language?: string, context?: string): Promise<string> {
 ...
 */
async function completeCode(code: string, cursorPosition?: number, language?: string): Promise<string> {

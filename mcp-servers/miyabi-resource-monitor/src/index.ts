...
function formatDiskInfo(disk: any) {
  return {
    filesystem: disk.fs,
    mount: disk.mount,
    type: disk.type,
 ...
 */
async function getResourceOverview(): Promise<any> {
 ...
 */
async function getProcesses(limit?: number): Promise<any> {
 ...
 * Get system uptime
 */
async function getUptime(): Promise<any> {

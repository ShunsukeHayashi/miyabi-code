#!/usr/bin/env node
/**
 * lark-bot-2025-11-20 - Lark Bot Application
 *
 * Auto-generated by Miyabi Lark Dev App Automation System
 * Generated at: 2025-11-20T03:10:37.864Z
 */
...
/**
 * API Wrapper: im.v1.message.receive_v1
 * Description: API for im.v1.message.receive_v1
 * Permission: im:message:readonly
 */
async function receive_v1Message(data = {}) {
  try {
    const token = await getTenantAccessToken();

    const response = await axios({
      method: 'POST',
      url: `${LARK_DOMAIN}/open-apis/im/v1/message/receive_v1`,
      headers: {
    ...
    if (response.data.code === 0) {
      console.log(`✅ im.v1.message.receive_v1 success`);
      return response.data.data;
    } else {
      throw new Error(`im.v1.message.receive_v1 failed: ${response.data.msg}`);
    }
  } catch (error) {
    console.error(`❌ im.v1.message.receive_v1 error:`, error.message);
    throw error;
  }
}
...
async function getChat(params = {}) {
  try {
    ...
    const response = await axios({
      method: 'GET',
      url: `${LARK_DOMAIN}/open-apis/im/v1/chat/get`,
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
      },
    ...
    if (response.data.code === 0) {
      console.log(`✅ im.v1.chat.get success`);
      return response.data.data;
    } else {
      throw new Error(`im.v1.chat.get failed: ${response.data.msg}`);
    }
  } catch (error) {
    console.error(`❌ im.v1.chat.get error:`, error.message);
    throw error;
  }
}
...
app.listen(PORT, () => {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🚀 lark-bot-2025-11-20');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');

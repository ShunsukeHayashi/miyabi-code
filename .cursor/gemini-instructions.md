...
```
@.claude/Skills/content-marketing-strategy/ このディレクトリの内容を要約して。重要なファイルか一時ファイルか判断して。
```
...
```bash
# クリップボードからファイルに保存
pbpaste > .claude/gemini-analysis-results.md
```
...
- **Gemini CLI使い方**: `.claude/docs/AI_CLI_COMPLETE_GUIDE.md` (Section 2)
- **比較ガイド**: `.claude/docs/AI_CLI_COMPARISON.md`

# Miyabi IAM Module
# ECS Task Execution Role and ECS Task Role

# ECS Task Execution Role (for pulling ECR images, accessing secrets)
...
# Application-specific permissions for ECS task

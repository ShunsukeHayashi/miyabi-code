...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const validatedData = CourseGenerationRequestSchema.parse(body);
    ...
    const result = await geminiClient.instance.generateCourse(geminiRequest);

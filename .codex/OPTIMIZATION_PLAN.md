# .codex Directory Optimization Plan
...
1. **Duplicate Content** 🔴
   - `agents.md` in root duplicates `.codex/context/agents.md`
...
4. **MCP Server Clutter** 🟡
   - 7 MCP server files in `.codex/mcp-servers/`
   - Mixed JS/CJS files
...
Move outdated content to `.codex/archive/`:
...
**Move to `docs/ai-cli/`**:
- `.codex/docs/AI_CLI_*.md` → `docs/ai-cli/`
...
- [ ] Create `.codex/archive/` directory
...
- [ ] Create `.codex/docs/` subdirectories
...
1. Create `.codex/INDEX.md` master index
2. Move duplicate `agents.md` → `agents.md.old`
3. Create `.codex/docs/` directory structure
4. Update main `.codex/README.md` with new structure

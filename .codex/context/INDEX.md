...
Codexは必要に応じて、これらのモジュールを動的にロードします。
...
- MCP Protocol: `.codex/MCP_INTEGRATION_PROTOCOL.md`
- Benchmark Checklist: `.codex/BENCHMARK_IMPLEMENTATION_CHECKLIST.md`

**Agent Specs**: `.codex/agents/specs/coding/*.md` | `.codex/agents/specs/business/*.md`
**Agent Prompts**: `.codex/agents/prompts/coding/*.md`
...
# 特定モジュール表示
cat .codex/context/core-rules.md

# トークン数推定
wc -w .codex/context/*.md
```

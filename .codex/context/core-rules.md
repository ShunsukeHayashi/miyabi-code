...
```bash
cat .codex/BENCHMARK_IMPLEMENTATION_CHECKLIST.md
```
...
| **Benchmark Protocol** | `cat .codex/BENCHMARK_IMPLEMENTATION_CHECKLIST.md` | [BENCHMARK_IMPLEMENTATION_CHECKLIST.md](..//BENCHMARK_IMPLEMENTATION_CHECKLIST.md) |

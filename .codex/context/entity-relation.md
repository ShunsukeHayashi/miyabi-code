...
| E7 | **Command** | `.codex/commands/*.md` | Codexコマンド |
...
**カテゴリ**:
- **Coding Agent仕様** (7ファイル): `.codex/agents/specs/coding/*.md`
- **Business Agent仕様** (14ファイル): `.codex/agents/specs/business/*.md`
- **Coding Agent実行プロンプト** (6ファイル): `.codex/agents/prompts/coding/*.md`
- **Codexコマンド** (9ファイル): `.codex/commands/*.md`

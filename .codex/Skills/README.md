...
This directory contains **15 specialized Skills** that extend Codex's capabilities for the Miyabi project.
...
**Location**: `.codex/Skills/rust-development/SKILL.md`
...
**Location**: `.codex/Skills/agent-execution/SKILL.md`
...
**Location**: `.codex/Skills/issue-analysis/SKILL.md`
...
**Location**: `.codex/Skills/documentation-generation/SKILL.md`
...
**Location**: `.codex/Skills/git-workflow/SKILL.md`
...
**Location**: `.codex/Skills/project-setup/SKILL.md`
...
- Miyabi framework integration (.miyabi.yml, .codex/ directory)
...
**Location**: `.codex/Skills/debugging-troubleshooting/SKILL.md`
...
**Location**: `.codex/Skills/performance-analysis/SKILL.md`
...
**Location**: `.codex/Skills/security-audit/SKILL.md`
...
**Location**: `.codex/Skills/dependency-management/SKILL.md`
...
**Location**: `.codex/Skills/business-strategy-planning/SKILL.md`
...
**Location**: `.codex/Skills/market-research-analysis/SKILL.md`
...
**Location**: `.codex/Skills/content-marketing-strategy/SKILL.md`
...
**Location**: `.codex/Skills/sales-crm-management/SKILL.md`
...
**Location**: `.codex/Skills/growth-analytics-dashboard/SKILL.md`
...
- **Agent Specifications**: `.codex/agents/specs/coding/*.md` - Individual Agent specs
...
**Miyabi Codex Skills** - Extending Claude's capabilities for autonomous development 🌸

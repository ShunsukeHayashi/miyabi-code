...
- Agent-specific prompt from `.codex/agents/prompts/coding/`

### Phase 4: Codex Execution
```bash
cd .worktrees/issue-270
# Codex reads EXECUTION_CONTEXT.md
...
- **Agent Prompts**: `.codex/agents/prompts/coding/*-agent-prompt.md`

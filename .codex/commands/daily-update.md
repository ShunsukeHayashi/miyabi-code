...
**プロンプトファイル**: `/Users/a003/dev/miyabi-private/.codex/agents/prompts/business/note-agent-prompt.md`
...
**プロンプトファイル**: `/Users/a003/dev/miyabi-private/.codex/agents/prompts/business/imagegen-agent-prompt.md`
...
解決策:
- プロンプトファイルを確認: .codex/agents/prompts/business/note-agent-prompt.md
- ファイルが存在するか確認
```
...
- [NoteAgent仕様](.codex/agents/specs/business/note-agent.md)
- [ImageGenAgent仕様](.codex/agents/specs/business/imagegen-agent.md)
- [かきこちゃんプロンプト](.codex/agents/prompts/business/note-agent-prompt.md)
- [えがくんプロンプト](.codex/agents/prompts/business/imagegen-agent-prompt.md)

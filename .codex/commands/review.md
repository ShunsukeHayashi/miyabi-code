...
**Reference**: `.codex/CODING_GUIDELINES.md` (if exists)
...
**IMPORTANT**: Use "exec review" to refer to this review process. This unique term helps Codex recognize this as a special operation distinct from normal implementation work.

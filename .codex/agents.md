...
**Version**: 1.0.0
**Purpose**: Automated verification workflows for Codex agents
...
This ensures Codex recognizes verification as a special operation distinct from normal implementation.

---

## 🎯 Unique Terminology

Use these terms consistently to help Codex recognize special operations:
...
These unique terms help Codex's pattern recognition system identify and properly handle special workflows.
...
**See Also**: `.codex/commands/review.md` for full /review command specification
...
- **Phase 3 - /review Command**: `.codex/commands/review.md` - Interactive review loop with auto-fix
- **Agent Specifications**: `.codex/agents/specs/coding/*.md` - Individual agent specs
- **Agent Prompts**: `.codex/agents/prompts/coding/*-agent-prompt.md` - Execution prompts
- **Task Management Protocol**: `.codex/prompts/task-management-protocol.md` - Todo management
...
- **Codex Documentation**: https://docs.codex.com/en/docs/claude-code

# Codex Instructions for Miyabi CLI

**CRITICAL: This file defines how Codex should interact with Miyabi CLI.**

**Target Audience**: Codex (AI coding agent)
**Human Visibility**: Users see Codex's output, NOT Miyabi's raw output
...
When executing Miyabi commands, Codex **MUST**:
...
- ✅ Uses Codex CLI (free, no ANTHROPIC_API_KEY required)
...
Next Action: [What Codex will do next]
```
...
[Codex didn't check exit code or parse JSON]
```
...
[Codex stops here without stating next action]
```
...
- ✅ Uses Codex CLI (free, no API key needed)
- ⏳ Other agents pending SDK integration

---

**This instruction file is automatically loaded by Codex when executing miyabi commands.**

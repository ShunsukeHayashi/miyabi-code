...
**作成日**: 2025-10-15
**目的**: `.codex`ディレクトリ内の全ドキュメントをRust移行に対応させる

## 📋 更新対象ファイル一覧

### 1. Agent仕様ファイル（specs/coding/）- 7ファイル

- [ ] `.codex/agents/specs/coding/coordinator-agent.md`
- [ ] `.codex/agents/specs/coding/codegen-agent.md`
- [ ] `.codex/agents/specs/coding/review-agent.md`
- [ ] `.codex/agents/specs/coding/issue-agent.md`
- [ ] `.codex/agents/specs/coding/pr-agent.md`
- [ ] `.codex/agents/specs/coding/deployment-agent.md`
- [ ] `.codex/agents/specs/coding/hooks-integration.md`
...
- [ ] `.codex/agents/prompts/coding/coordinator-agent-prompt.md`
- [ ] `.codex/agents/prompts/coding/codegen-agent-prompt.md`
- [ ] `.codex/agents/prompts/coding/review-agent-prompt.md`
- [ ] `.codex/agents/prompts/coding/issue-agent-prompt.md`
- [ ] `.codex/agents/prompts/coding/pr-agent-prompt.md`
- [ ] `.codex/agents/prompts/coding/deployment-agent-prompt.md`
...
- [ ] `.codex/commands/agent-run.md`
- [ ] `.codex/commands/create-issue.md`
- [ ] `.codex/commands/deploy.md`
- [ ] `.codex/commands/generate-docs.md`
- [ ] `.codex/commands/miyabi-auto.md`
- [ ] `.codex/commands/miyabi-todos.md`
- [ ] `.codex/commands/review.md`
- [ ] `.codex/commands/security-scan.md`
...
- [ ] `.codex/agents/AGENT_CHARACTERS.md`
- [ ] `.codex/agents/USAGE_GUIDE_SIMPLE.md`
...
2. `.codex/QUICK_START.md` - クイックスタートガイド
3. `.codex/agents/README.md` - Agent概要

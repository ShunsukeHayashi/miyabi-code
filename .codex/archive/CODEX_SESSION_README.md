...
**このファイルはCodexセッション（別スレッドのCodex）専用です。**
...
### AI CLI関連
- `.codex/docs/AI_CLI_COMPLETE_GUIDE.md` - AI CLI完全ガイド
- `.codex/docs/AI_CLI_COMPARISON.md` - 使い分けガイド
- `.codex/docs/CODEX_CLARIFICATION.md` - Codex定義明確化

### テンプレート
- `.codex/templates/reporting-protocol.md` - 報告プロトコル

...
Include at least 2-3 alternative perspectives or solutions in your analysis.`;
     ...
     */
    async compareOptions(question, options, criteria) {
...
4. Explain trade-offs clearly`;
        ...
        const response = await this.client.generateStructuredContent(comparisonPrompt, responseSchema, {
            thinkingLevel: 'high',
            tools: {
                googleSearch: true,
                codeExecution: false,
     ...
     */
    async analyzeDecision(decision, context, timeHorizon) {
...
5. Suggest mitigation strategies for identified risks`;
        ...
        const response = await this.client.generateStructuredContent(decisionPrompt, responseSchema, {
            thinkingLevel: 'high',
            tools: {
                googleSearch: true,
                codeExecution: false,

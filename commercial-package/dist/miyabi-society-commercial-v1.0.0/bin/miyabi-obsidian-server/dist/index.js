 ...
 */
async function createDocument(filePath, content, frontmatter) {
 ...
 */
async function updateDocument(filePath, content, frontmatterUpdates) {
 ...
 */
async function getDirectoryTree(basePath = "") {
    ...
    try {
        switch (name) {
            ...
            case "obsidian_search": {
                const { query, case_sensitive, category, tags } = args;

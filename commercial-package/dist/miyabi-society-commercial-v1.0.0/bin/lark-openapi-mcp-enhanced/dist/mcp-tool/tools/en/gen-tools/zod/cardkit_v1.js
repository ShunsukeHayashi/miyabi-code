...
exports.cardkitV1CardCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            type: zod_1.z.string().describe('Type of card data. Take the fixed value `card_json`'),
            data: zod_1.z
                .string()
                .describe('The contents of the card JSON data. Only  is supported, i.e. you must declare the schema as 2.0. The following example values are not escaped, please be careful to convert them to JSON serialized strings when using them'),
        }),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            uuid: zod_1.z
                ...
                .optional(),
            content: zod_1.z.string().describe('Updated text content'),
            sequence: zod_1.z
                .number()
                .describe('Sequence number, used to ensure the timing of updating text content. During the single streaming mode cycle of the card (steaming state from start to stop), this value needs to be an increasing positive integer, otherwise an error will be reported'),
        }),
        path: zod_1.z.object({
            card_id: zod_1.z.string().describe('Card entity ID. Get it by '),
...
exports.cardkitV1CardIdConvert = {
    ...
    schema: {
        data: zod_1.z.object({
            message_id: zod_1.z.string().describe('Message ID. Get via '),
        }),
    },
};
exports.cardkitV1CardSettings = {
    ...
    schema: {
        data: zod_1.z.object({
            settings: zod_1.z
                .string()
                .describe("Card configuration related fields, including'config 'and 'card_link' fields. The following example values are not escaped, please be careful to convert them to JSON serialized strings when using them. For detailed field descriptions, refer to "),
            uuid: zod_1.z
                .string()
                .describe('Idempotent ID, which can be passed in a unique UUID to ensure that the same batch of operations is performed only once')
                .optional(),

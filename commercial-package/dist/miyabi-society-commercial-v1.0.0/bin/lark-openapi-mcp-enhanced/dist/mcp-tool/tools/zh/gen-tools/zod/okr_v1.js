...
exports.okrV1OkrBatchGet = {
    ...
    schema: {
        params: zod_1.z.object({
            ...
            okr_ids: zod_1.z.array(zod_1.z.string()).describe('OKR ID 列表，最多10个'),
            lang: zod_1.z.string().describe('请求OKR的语言版本（比如@的人名），lang=en_us/zh_cn，请求 Query中').optional(),
        }),
...
exports.okrV1PeriodCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            period_rule_id: zod_1.z.string().describe('周期规则 id'),
            start_month: zod_1.z.string().describe('周期起始年月'),
        }),
    },
};
    ...
    schema: {
        params: zod_1.z.object({
            page_token: zod_1.z
                ...
                .optional(),
            page_size: zod_1.z.number().describe('分页大小，默认10').optional(),
        }),
    },
};
exports.okrV1PeriodPatch = {
    ...
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-OKR-OKR 周期-修改 OKR 周期状态-修改某个 OKR 周期的状态为「正常」、「失效」或「隐藏」，对租户所有人生效，请谨慎操作',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            status: zod_1.z
        ...
        path: zod_1.z.object({ period_id: zod_1.z.string().describe('周期id') }),
    },
};
exports.okrV1ProgressRecordCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            source_title: zod_1.z.string().describe('进展来源'),
            source_url: zod_1.z.string().describe('进展来源链接'),
            target_id: zod_1.z.string().describe('目标id，与target_type对应'),
            target_type: zod_1.z.number().describe('目标类型 Options:2(objective okr的O),3(key_result okr的KR)'),
            content: zod_1.z
                .object({
                blocks: zod_1.z
                    ...
                    paragraph: zod_1.z
                        ...
                        style: zod_1.z
                            ...
                            list: zod_1.z
                                ...
                                type: zod_1.z
                                    ...
                                    .describe('列表类型 Options:number(有序列表),bullet(无序列表),checkBox(任务列表),checkedBox(已完成的任务列表),indent(tab缩进)')
                                    .optional(),
                                indentLevel: zod_1.z
                                    .number()
                                    .describe('列表的缩进级别，支持指定一行的缩进 除代码块以外的列表都支持设置缩进，支持 1-16 级缩进，取值范围：[1,16]')
                                    .optional(),
                                number: zod_1.z
                                    .number()
                                    .describe('用于指定列表的行号，仅对有序列表和代码块生效 如果为有序列表设置了缩进，行号可能会显示为字母或者罗马数字')
                                    .optional(),
                            })
                        ...
                        elements: zod_1.z
                            ...
                            type: zod_1.z
                                ...
                                .describe('元素类型 Options:textRun(文本型元素),docsLink(文档链接型元素),person(艾特用户型元素)')
                                .optional(),
                            textRun: zod_1.z
                                .object({
                                text: zod_1.z.string().describe('具体的文本内容').optional(),
                                style: zod_1.z
                                    .object({
                                    bold: zod_1.z.boolean().describe('是否加粗').optional(),
                                    strikeThrough: zod_1.z.boolean().describe('是否删除').optional(),
                                    backColor: zod_1.z
                                        .object({
                                        red: zod_1.z.number().describe('红 取值范围[0,255]').optional(),
                                        green: zod_1.z.number().describe('绿 取值范围[0,255]').optional(),
                                        blue: zod_1.z.number().describe('蓝 取值范围[0,255]').optional(),
                                        alpha: zod_1.z.number().describe('透明度 取值范围[0,1]').optional(),
                                    })
                                        .describe('背景颜色')
                                        .optional(),
                                    textColor: zod_1.z
                                        ...
                                        .optional(),
                                    link: zod_1.z
                                        .object({ url: zod_1.z.string().describe('链接地址').optional() })
                                        .describe('链接地址')
                                        .optional(),
                                })
                            ...
                            docsLink: zod_1.z
                                .object({
                                url: zod_1.z.string().describe('飞书云文档链接地址').optional(),
                                title: zod_1.z.string().describe('飞书云文档标题').optional(),
                            })
                                .describe('飞书云文档')
                                .optional(),
                            person: zod_1.z
                                .object({ openId: zod_1.z.string().describe('员工的OpenID').optional() })
                                .describe('艾特用户')
                                .optional(),
                        }))
                            .describe('段落元素组成一个段落')
                    ...
                    gallery: zod_1.z
                        ...
                        imageList: zod_1.z
                            .array(zod_1.z.object({
                            fileToken: zod_1.z.string().describe('图片 token，通过上传图片接口获取').optional(),
                            src: zod_1.z.string().describe('图片链接').optional(),
                            width: zod_1.z.number().describe('图片宽，单位px').optional(),
                            height: zod_1.z.number().describe('图片高，单位px').optional(),
                        }))
                            .describe('图片元素')
                            .optional(),
                    })
                ...
                .describe('进展详情 富文本格式'),
            source_url_pc: zod_1.z.string().describe('pc进展来源链接').optional(),
            source_url_mobile: zod_1.z.string().describe('mobile进展来源链接').optional(),
        }),
...
exports.okrV1ProgressRecordDelete = {
    ...
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({ progress_id: zod_1.z.string().describe('待删除的 OKR进展记录 ID') }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.okrV1ProgressRecordGet = {
    ...
    schema: {
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional() }),
        path: zod_1.z.object({ progress_id: zod_1.z.string().describe('待查询的 OKR进展记录 ID').optional() }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.okrV1ProgressRecordUpdate = {
    ...
    schema: {
        ...
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional() }),
        path: zod_1.z.object({ progress_id: zod_1.z.string().describe('待更新的 OKR进展记录 ID') }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.okrV1ReviewQuery = {
    ...
    schema: {
        params: zod_1.z.object({
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id', 'people_admin_id']).describe('用户ID类型').optional(),
            user_ids: zod_1.z.array(zod_1.z.string()).describe('目标用户id列表，最多5个'),
            period_ids: zod_1.z.array(zod_1.z.string()).describe('period_id列表，最多5个'),
        }),
    },
};
exports.okrV1UserOkrList = {
    ...
    schema: {
        params: zod_1.z.object({
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id', 'people_admin_id']).describe('用户ID类型').optional(),
            offset: zod_1.z.string().describe('请求列表的偏移（对应响应体的 okr_list 字段），offset>=0'),
            limit: zod_1.z.string().describe('列表长度，0-10'),
            lang: zod_1.z.string().describe('请求OKR的语言版本（比如@的人名），lang=en_us/zh_cn').optional(),
            period_ids: zod_1.z.array(zod_1.z.string()).describe('period_id列表，最多10个').optional(),
        }),
        path: zod_1.z.object({ user_id: zod_1.z.string().describe('目标用户id').optional() }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.okrV1Tools = [

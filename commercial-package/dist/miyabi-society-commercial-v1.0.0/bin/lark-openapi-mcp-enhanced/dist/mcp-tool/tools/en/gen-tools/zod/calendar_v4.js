    ...
    schema: {
        data: zod_1.z.object({
            ...
            scope: zod_1.z
                ...
                user_id: zod_1.z.string().describe('User ID, for more information, you can refer to the ').optional(),
            })
        ...
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('The calendar ID for which access control needs to be added.The calendar ID is returned when a shared calendar is created. You can also call the following interfaces to obtain the ID of a calendar.- - - '),
        }),
...
exports.calendarV4CalendarAclDelete = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('The ID of the calendar for which access control needs to be deleted is required.The calendar ID is returned when a shared calendar is created. You can also call the following interfaces to obtain the ID of a calendar.- - - '),
            acl_id: zod_1.z
                .string()
                .describe('Access control ID.The access control ID is returned when access control is created for the calendar. You can also call the  interface to get the access control information within the specified calendar'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarAclList = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.The calendar ID is returned when creating a shared calendar. You can also call the following interfaces to obtain the ID of a calendar.- - - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarAclSubscription = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID. The calendar ID is returned when a shared calendar is created. You can also call the following interfaces to obtain the ID of a calendar.- - - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.calendarV4CalendarDelete = {
    ...
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.When creating a shared calendar, the calendar ID will be returned. You can also call the following interfaces to get the ID of a calendar.- - - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            attendee_ids: zod_1.z
                ...
                .describe('List of invitee IDs that need to be deleted.When adding a event invitee, the invitee ID (attendee_id) will be returned. You can also call  Interface to query the invitee ID of the specified event.- Up to 500 attendees can be deleted at a time (counted together with delete_ids)')
                .optional(),
            delete_ids: zod_1.z
                ...
                user_id: zod_1.z
                    .string()
                    .describe("Event invitee's user ID, which depends on the returned user_id_type parameter. When is_external is true, this field returns the open_id or union_id. For more information, see ")
                    .optional(),
                chat_id: zod_1.z
                    .string()
        ...
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('Calendar ID. For details, see '),
            event_id: zod_1.z
                .string()
                .describe('Event ID.The event ID is returned when creating a event. You can also call the following interface to obtain the ID of a certain calendar.- - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventAttendeeChatMemberList = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            ...
            attendee_id: zod_1.z
                .string()
                .describe('Group type invitee ID.When adding a event invitee, the invitee ID (attendee_id) will be returned. You can also call  Interface to query the invitee ID of the specified event'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            attendees: zod_1.z
                ...
                is_optional: zod_1.z
                    .boolean()
                    .describe('Whether the invitee is optional.**Optional values are**:- true- false**Note**: This field cannot be edited for group invitees')
                    .optional(),
                user_id: zod_1.z
                    .string()
                    .describe('User ID. When selecting a user type invitee (the value of type is user), this parameter needs to be passed in. The user ID type passed in needs to be consistent with the value of user_id_type. For information about user IDs, see ')
                    .optional(),
                chat_id: zod_1.z
                    .string()
                    .describe('Group ID. When selecting group type invitees (type value is chat), this parameter needs to be passed in. For details about group ID, please refer to ')
                    .optional(),
                room_id: zod_1.z
                    .string()
                    .describe('Meeting room ID. When selecting meeting room type invitees (type value is resource), this parameter needs to be passed in.You can obtain the specified meeting room ID through the following interface:- - ')
                    .optional(),
                ...
                operate_id: zod_1.z
                    .string()
                    .describe('Meeting room contact ID. The user ID type passed in needs to be consistent with the value of user_id_type. For information about user IDs, see .**Note**: If the current schedule is created based on the application identity, when adding a meeting room type invitee, you need to specify the contact person of the meeting room through this parameter, and the contact will be displayed in the schedule meeting room information.**Default**: empty')
                    .optional(),
        ...
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('The calendar ID corresponding to the event. To learn more, see '),
            event_id: zod_1.z
                .string()
                .describe('Event ID.The event ID is returned when creating a event. You can also call the following interface to obtain the ID of a certain calendar.- - '),
        }),
    ...
    schema: {
        params: zod_1.z.object({
            ...
            need_resource_customization: zod_1.z
                .boolean()
                .describe('Whether meeting room form information is required.**Optional values are**:- true: required- false (default): not required**Note**: The current identity needs to have the editing rights of the event to return the meeting room form information, that is, the current identity needs to be the organizer of the event, or a invitee of the event and the event is set to **Invitees can edit the event** permissions. You can call the  interface to obtain the invitee permissions (attendee_ability) of the event')
                .optional(),
            page_token: zod_1.z
                .string()
                .describe('Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups')
        ...
        path: zod_1.z.object({
            ...
            event_id: zod_1.z
                .string()
                .describe('Evnet ID.The evnet ID is returned when creating a evnet. You can also call the following interface to obtain the ID of a certain calendar.- - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            ...
            start_time: zod_1.z
                ...
                date: zod_1.z
                    .string()
                    .describe('Start time, only use this field for all-day events,  format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                    .optional(),
                timestamp: zod_1.z
                    .string()
            ...
            end_time: zod_1.z
                ...
                date: zod_1.z
                    .string()
                    .describe('End time, only use this field for all-day events,  format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                    .optional(),
                timestamp: zod_1.z
                    .string()
            ...
            recurrence: zod_1.z
                .string()
                .describe('Recurrence rule for recurring events. For details, see .**Default value**: empty, indicating that the current event is not a repeating event.**Note**:- COUNT and UNTIL cannot coexist;- The length of a scheduled recurring event in a room cannot exceed two years')
                .optional(),
            schemas: zod_1.z
                .array(zod_1.z.object({
                ui_name: zod_1.z
        ...
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.The calendar ID is returned when creating a shared calendar. You can also call the following interface to obtain the ID of a certain calendar.- - - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventDelete = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('The calendar ID where the event is located. See '),
            event_id: zod_1.z.string().describe('Event ID. How to get it:-  will return the event ID- - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
    ...
    schema: {
        params: zod_1.z.object({
            need_meeting_settings: zod_1.z
                .boolean()
                .describe('Do you need to return to the pre-meeting settings of Feishu Video Conferencing (VC)? The following conditions must be met to obtain the returned results:- The meeting type (vc_type) of the event needs to be vc.- Requires editing permissions for event.**Optional values are**:- true- false (default)')
                .optional(),
            need_attendee: zod_1.z
                .boolean()
                .describe('Do you need to return invitee information?**Optional values are**:- true- false (default)')
                .optional(),
            max_attendee_num: zod_1.z
                .number()
...
exports.calendarV4CalendarEventInstanceView = {
    project: 'calendar',
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Calendar-Event management-Query event view-Call this interface with user identity to query the event view under a specified calendar. Unlike , the current interface will expand into multiple event instances according to the repetitiveness rules of the recurring event, and return the corresponding event instance information according to the queried time interval',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            start_time: zod_1.z
                .string()
                .describe('Start time, Unix timestamp in seconds. This parameter and end_time are used to set the time range of the query.**Note**: The time interval between start_time and end_time needs to be less than 40 days'),
            end_time: zod_1.z
                .string()
                .describe('End time, Unix timestamp in seconds. This parameter is used with start_time to set the time range of the query.**Note**: The time interval between start_time and end_time needs to be less than 40 days'),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('Calendar ID. For information about calendar ID, please refer to '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventInstances = {
    project: 'calendar',
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Calendar-Event management-Get Event instances-Call this interface with the current identity (app or user) to obtain information about a specific recurring event in a specified calendar',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            start_time: zod_1.z
                .string()
                .describe('Start time, Unix timestamp in seconds. This parameter and end_time are used to set the time range, that is, the query interval for repeated events is (start_time, end_time)**Note**: The time interval between start_time and end_time cannot exceed 2 years'),
            end_time: zod_1.z
                .string()
                .describe('End time, Unix timestamp in seconds. This parameter and start_time are used to set the time range, that is, the query interval for repeated events is (start_time, end_time)**Note**: The time interval between start_time and end_time cannot exceed 2 years'),
            page_size: zod_1.z.number().describe('The maximum number of events returned in one call').optional(),
            page_token: zod_1.z
                .string()
                .describe('Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups')
                .optional(),
...
exports.calendarV4CalendarEventMeetingChatCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Meeting Chat-Create meeting chat-Call this interface in the current identity (app or user) to create a meeting group for a specific event',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('The calendar ID where the event is located. To learn more, see '),
            event_id: zod_1.z
                .string()
                .describe('event ID.The event ID is returned when creating a event. You can also call the following interface to obtain the ID of a certain calendar.- - '),
        }),
...
exports.calendarV4CalendarEventMeetingChatDelete = {
    ...
    path: '/open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/meeting_chat',
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Calendar-Meeting Chat-Unbind meeting chat-Call this interface in the current identity (app or user) to unbind the created meeting group for the event',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            meeting_chat_id: zod_1.z.string().describe('Meeting group ID. The group ID is returned when the group is created'),
        }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('The calendar ID where the event is located'),
            event_id: zod_1.z.string().describe('Event ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventMeetingMinuteCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Meeting Minute-Create meeting minute-Call this interface to create meeting minutes for the specified schedule. The minutes are displayed in the form of documents, and the minutes document URL will be returned after successful creation',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
            ...
            event_id: zod_1.z
                .string()
                .describe('Event ID. Call the  interface to search for event in the specified calendar and obtain the event ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarEventPatch = {
    ...
    path: '/open-apis/calendar/v4/calendars/:calendar_id/events/:event_id',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Calendar-Event management-Update Event-Call this interface with the current identity (app or user) to update a event on a specific calendar, including information such as the event title, description, start and end time, video conference, and event location',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            summary: zod_1.z
            ...
            description: zod_1.z
                .string()
                .describe('Event description.**Note**: The current API method does not support editing rich text descriptions. If the event description is edited as rich text content via the client, updating the description using the API will cause the rich text formatting to be lost.**Default value**: empty, indicating that the field will not be updated')
                .optional(),
            need_notification: zod_1.z
                .boolean()
                .describe('Whether to send Bot notifications to event invitees when updating the event.**Default value**: empty, indicating that the field will not be updated**Optional values are**:- true: send notification- false: Do not send notifications')
                .optional(),
            start_time: zod_1.z
                .object({
                date: zod_1.z
            ...
            vchat: zod_1.z
                ...
                vc_type: zod_1.z
                    .enum(['vc', 'third_party', 'no_meeting', 'lark_live', 'unknown'])
                    .describe('Video conferencing type. If video conferencing is not required, `no_meeting` must be passed. Options:vc(Feishu video conferencing. When this type is selected, other fields in vchat are invalid.),third_party(ThirdParty Third-party linked video conferencing. When this type is selected, only the icon_type, description, and meeting_url fields in vchat will take effect.),no_meeting(NoMeeting No video conferencing. When this type is selected, other fields in vchat are invalid.),lark_live(LarkLive Feishu Live. This value is for client use, does not support calls via API, and is read-only.),unknown(Unknown type. This value is used for client compatibility, does not support API calls, and is read-only.)')
                    .optional(),
                icon_type: zod_1.z
                    .enum(['vc', 'live', 'default'])
                    .describe('The icon type for third-party video conferencing.**Default value**: empty, indicating that the field will not be updated Options:vc(Feishu Video Conference icon),live(Livestream video conference icon),default(Default icon)')
                    .optional(),
                description: zod_1.z
                    .string()
                    .describe('Third-party video conferencing copywriting.**Default value**: empty, indicating that the field will not be updated')
                    .optional(),
                meeting_url: zod_1.z
                    .string()
                ...
                meeting_settings: zod_1.z
                    ...
                    owner_id: zod_1.z
                        .string()
                        .describe('Set the user ID of the conference owner. The ID type must be consistent with user_id_type.This parameter must meet all of the following conditions to take effect:- Apply identity (tenant_access_token) request and operate event on the application calendar.- The owner can only be set when the event is set to a VC meeting for the first time.- owner cannot be a non-user identity.- owner cannot be an external tenant user identity')
                        .optional(),
                    join_meeting_permission: zod_1.z
                        .enum(['anyone_can_join', 'only_organization_employees', 'only_event_attendees'])
                        .describe('Determine who can join the meeting. Options:anyone_can_join(AnyOne Any user can join the meeting),only_organization_employees(OnlySameOrganization Only users that from the same organization can join the meeting),only_event_attendees(OnlyEventAttendees Only event attendees can join the meeting)')
                        .optional(),
                    assign_hosts: zod_1.z
                        .array(zod_1.z.string())
                    ...
                    auto_record: zod_1.z
                        .boolean()
                        .describe('Whether to enable automatic recording.**Optional values are**:- true: enable- false: disable**Default value**: empty, indicating that the field will not be updated')
                        .optional(),
                    open_lobby: zod_1.z
                        .boolean()
                        .describe('Whether to enable the waiting room.**Optional values are**:- true: enable- false: disable**Default value**: empty, indicating that the field will not be updated')
                        .optional(),
                    allow_attendees_start: zod_1.z
                        .boolean()
                        .describe('Whether to allow event invitees to initiate meetings.**Note**: When operating event on the application calendar, this field must be true, otherwise no one can initiate a meeting.**Optional values are**:- true: allow- false: not allowed**Default value**: empty, indicating that the field will not be updated')
                        .optional(),
                })
                    .describe('The pre-meeting settings of Feishu Video Conference (VC) must meet all the following conditions:- Valid when `vc_type` is `vc`.- Requires editing permissions for event.Not passing a value means that the field will not be updated')
                    .optional(),
            })
            ...
            visibility: zod_1.z
                .enum(['default', 'public', 'private'])
                .describe('Event visibility.**Note**: If the parameter value is modified when updating the event, it will only take effect for the current identity.**Default value**: empty, indicating that the field will not be updated Options:default(Default range, which depends on the calendar visibility. Only the availability status is visible to other people by default.),public(Public. Event details are displayed.),private(Private. Details are visible only to the current identity.)')
                .optional(),
            attendee_ability: zod_1.z
                .enum(['none', 'can_see_others', 'can_invite_others', 'can_modify_event'])
                .describe('Invitee permissions.**Default value**: empty, indicating that the field will not be updated Options:none(Cannot edit events, cannot invite others, and cannot view event invitee list),can_see_others(CanSeeOthers Cannot edit events, cannot invite others, and can view event invitee list),can_invite_others(CanInviteOthers Cannot edit events, can invite others, and can view event invitee list),can_modify_event(CanModifyEvent Can edit events, can invite others, and can view event invitee list)')
                .optional(),
            free_busy_status: zod_1.z
                .enum(['busy', 'free'])
                .describe('Busy status occupied by the event. The default for new events is `busy`.**Note**: If the parameter value is modified when updating the event, it will only take effect for the current identity.**Default value**: empty, indicating that the field will not be updated Options:busy(Busy),free(Free)')
                .optional(),
            location: zod_1.z
                .object({
                name: zod_1.z.string().describe('Name of the location').optional(),
            ...
            recurrence: zod_1.z
                .string()
                .describe('Recurrence rule for recurring events. For details, see .**Note**:- COUNT and UNTIL cannot coexist;- The length of a scheduled recurring event in a room cannot exceed two years.**Default value**: empty, indicating that the field will not be updated')
                .optional(),
            schemas: zod_1.z
                .array(zod_1.z.object({
                ui_name: zod_1.z
                ...
                ui_status: zod_1.z
                    .enum(['hide', 'readonly', 'editable', 'unknown'])
                    .describe('Custom status of UI items. Only "hide" is supported. Options:hide(Hidden),readonly(Read-only),editable(Editable),unknown(Unknown. This is only used for compatibility in reading.)')
                    .optional(),
                app_link: zod_1.z
                    .string()
                    .describe('The link that jumps after clicking the button.**Note**: The compatibility parameter is read-only, so passing in this request parameter is not supported yet')
                    .optional(),
            }))
                .describe('Event custom information controls the UI display of the event details page. Not passing a value means that the field will not be updated')
                .optional(),
            attachments: zod_1.z
                .array(zod_1.z.object({
                file_token: zod_1.z
...
exports.calendarV4CalendarEventReply = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Event management-Reply Event-Call this interface to reply to the event with the current identity (app or user)',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            rsvp_status: zod_1.z
                .enum(['accept', 'decline', 'tentative'])
                .describe('Event invitee RSVP status, that is, event reply status. Options:accept(accept),decline(refuse),tentative(To be determined)'),
        }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('The calendar ID where the event is located. To learn more, see '),
            event_id: zod_1.z
...
exports.calendarV4CalendarEventSearch = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Event management-Search Event-Call this interface to search for relevant events under the specified calendar, supporting keyword search and filter condition search',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            query: zod_1.z
                .string()
                .describe('Search for the keyword. Used to fuzzy query event name.**Notice**: If the event name contains an underscore (_), you must search for it accurately. This scene fuzzy search may not search for the event'),
            filter: zod_1.z
                .object({
                start_time: zod_1.z
                    .object({
                    date: zod_1.z
                        .string()
                        .describe('Specify the start time in days, in  format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                        .optional(),
                    timestamp: zod_1.z
                        .string()
                        .describe('Second-level timestamp refers to the specific start time. For example, 1602504000 means 2020/10/12 20:00:00 (UTC +8 time zone).**Note**: This parameter cannot be specified at the same time as `date`')
                        .optional(),
                    timezone: zod_1.z
                        .string()
                        .describe('Time zone. Use IANA Time Zone Database standards such as Asia/Shanghai.- The time zone is fixed to UTC +0 throughout the day- The non-all-day time zone defaults to Asia/Shanghai')
                        .optional(),
                })
                    .describe('Search filter items, start time of event search interval. **Notice**: If start_time and end_time are not passed, the default search is for events within the past month')
                    .optional(),
                end_time: zod_1.z
                    .object({
                    date: zod_1.z
                        .string()
                        .describe('Specify the end time in days, in  format, for example, 2018-09-01.**Note**: This parameter cannot be specified at the same time as `timestamp`')
                        .optional(),
                    timestamp: zod_1.z
                        .string()
                        .describe('Second-level timestamp refers to the specific end time. For example, 1602504000 means 2020/10/12 20:00:00 (UTC +8 time zone).**Note**: This parameter cannot be specified at the same time as `date`')
                        .optional(),
                    timezone: zod_1.z
                        .string()
                        .describe('Time zone. Use IANA Time Zone Database standards such as Asia/Shanghai.- The time zone is fixed to UTC +0 throughout the day- The non-all-day time zone defaults to Asia/Shanghai')
                    ...
                    .describe('Search filter items, end time of event search interval. **Notice**: If start_time and end_time are not passed, the default search is for events within the past month')
                    .optional(),
                user_ids: zod_1.z
                    .array(zod_1.z.string())
                    .describe('Search filter item, list of user IDs of event invitees. After setting this field, the searched event contains at least one of the invitees.**Note**: The user ID type is consistent with the value of user_id_type. For user ID, please refer to .**Default value**: empty, indicating that the filter item is not set')
                    .optional(),
                room_ids: zod_1.z
                    .array(zod_1.z.string())
                    .describe('Search filter items, meeting room ID list. After setting this field, the searched event contains at least one of the meeting rooms.**Default value**: empty, indicating that the filter item is not set')
                    .optional(),
                chat_ids: zod_1.z
                    .array(zod_1.z.string())
                    .describe('Search filter items, group ID list. After setting this field, the searched event contains at least one of these groups. For details about group ID, please refer to .**Default value**: empty, indicating that the filter item is not set')
                    .optional(),
            })
        ...
        params: zod_1.z.object({
            ...
            page_size: zod_1.z
                .number()
                .describe('The maximum number of events returned in one call. The minimum value is 10, and if fewer than 10, defaults to 10')
                .optional(),
        }),
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('Calendar ID. For details, see '),
...
exports.calendarV4CalendarEventSubscription = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Event management-Subscribe Event Changes-Call this interface with user identity to subscribe to event change events under a specified calendar',
    accessTokens: ['user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('Calendar ID. For details, see '),
...
exports.calendarV4CalendarEventUnsubscription = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Event management-Unsubscribe Event Changes-Call this interface to unsubscribe from event change events in the specified calendar as a user',
    accessTokens: ['user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z.string().describe('Calendar ID. For details, see '),
...
exports.calendarV4CalendarGet = {
    project: 'calendar',
    name: 'calendar.v4.calendar.get',
    sdkName: 'calendar.v4.calendar.get',
    path: '/open-apis/calendar/v4/calendars/:calendar_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Calendar-Calendar management-Query calendar information-Call this interface to query the information of a specified calendar with the current identity (application or user)',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
...
exports.calendarV4CalendarList = {
    project: 'calendar',
    name: 'calendar.v4.calendar.list',
    sdkName: 'calendar.v4.calendar.list',
    path: '/open-apis/calendar/v4/calendars',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Calendar-Calendar management-Query the calendar list-Call this interface to page through and query the calendar list of the current identity (application or user)',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            page_size: zod_1.z
                .number()
                .describe('The maximum number of calendars to be returned for one request. The actual number of calendars returned may be less than this value, or it may be empty, and you can determine if there are more calendars based on the has_more field in the response body')
                .optional(),
            page_token: zod_1.z
                .string()
                .describe('Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups')
            ...
            sync_token: zod_1.z
                .string()
                .describe('Incremental synchronization mark, no need to fill in for the first request. When the page query ends (the returned value of page_token is empty), the interface will return the sync_token field. The next call can use this sync_token to incrementally obtain calendar change data')
                .optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarPatch = {
    project: 'calendar',
    name: 'calendar.v4.calendar.patch',
    sdkName: 'calendar.v4.calendar.patch',
    path: '/open-apis/calendar/v4/calendars/:calendar_id',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Calendar-Calendar management-Update calendar information-Call this interface with the current identity (application or user) to modify the title, description, public range, and other information of the specified calendar',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            summary: zod_1.z.string().describe('Calendar title.- Not providing this field means it will not be updated').optional(),
            description: zod_1.z
                .string()
            ...
            permissions: zod_1.z
                .enum(['private', 'show_only_free_busy', 'public'])
                .describe('Calendar visibility range.- Not providing this field means it will not be updated. Options:private(Private),show_only_free_busy(ShowOnlyFreeBusy Only availability information is displayed.),public(Public. Event details are visible to other people)')
                .optional(),
            color: zod_1.z
                .number()
            ...
            summary_alias: zod_1.z
                .string()
                .describe('Calendar alias, setting this field (including subsequent modification of this field) only takes effect for the current identity.- Not providing this field means it will not be updated')
                .optional(),
        }),
        path: zod_1.z.object({
            calendar_id: zod_1.z
...
exports.calendarV4CalendarPrimary = {
    project: 'calendar',
    name: 'calendar.v4.calendar.primary',
    sdkName: 'calendar.v4.calendar.primary',
    path: '/open-apis/calendar/v4/calendars/primary',
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Query primary calendar information-Call this interface to get the main calendar information of the current identity (application or user)',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
...
exports.calendarV4CalendarSearch = {
    project: 'calendar',
    name: 'calendar.v4.calendar.search',
    sdkName: 'calendar.v4.calendar.search',
    path: '/open-apis/calendar/v4/calendars/search',
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Calendar-Calendar management-Search Calendar-Invoke this interface to search the calendar by keyword. The search results will be public calendars or the user's main calendar where the title or description contains the keyword",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            query: zod_1.z
                .string()
                .describe("Search keyword. The interface will search public calendars or the user's main calendar where the title or description contains this keyword"),
        }),
        params: zod_1.z.object({
            page_token: zod_1.z
                .string()
                .describe('Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups')
                .optional(),
            page_size: zod_1.z.number().describe('The maximum number of calendars returned in a single request').optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarSubscribe = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Subscribe Calendar-Call this interface to subscribe to the specified calendar with the current identity (application or user)',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
                .string()
                .describe('Calendar ID.The calendar ID will be returned when creating a shared calendar. You also can call the following interfaces to get the ID of a certain calendar.- - - '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarSubscription = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Subscribe Calendar Changes -Call this interface to subscribe the current user identity to the ',
    accessTokens: ['user'],
    schema: {
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4CalendarUnsubscribe = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Unsubscribe Calendar-Call this interface with the current identity (application or user) to unsubscribe from the specified calendar',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            calendar_id: zod_1.z
...
exports.calendarV4CalendarUnsubscription = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Calendar management-Unsubscribe Calendar Changes-Call this interface to unsubscribe the current user identity from the ',
    accessTokens: ['user'],
    schema: {
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4ExchangeBindingCreate = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Synchronize Exchange calendar information-Bind Exchange account to Feishu account-Call this interface to bind the Exchange account to the Feishu account, thereby supporting the import of the Exchange calendar',
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({
            admin_account: zod_1.z.string().describe('The admin account of Exchange').optional(),
            exchange_account: zod_1.z.string().describe('The Exchange account that needs to be bound').optional(),
            user_id: zod_1.z
                .string()
...
exports.calendarV4ExchangeBindingDelete = {
    project: 'calendar',
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Calendar-Synchronize Exchange calendar information-Unbind the Exchange account-Call this interface to unbind the relationship between the Exchange account and the Feishu account. After the Exchange account is unbound, it can continue to bind with other Feishu accounts',
    accessTokens: ['user'],
    schema: {
        path: zod_1.z.object({
            exchange_binding_id: zod_1.z
                .string()
                .describe('The unique identification ID bound to Exchange. When calling , the exchange_binding_id can be obtained from the returned result'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4ExchangeBindingGet = {
    project: 'calendar',
    name: 'calendar.v4.exchangeBinding.get',
    sdkName: 'calendar.v4.exchangeBinding.get',
    path: '/open-apis/calendar/v4/exchange_bindings/:exchange_binding_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Calendar-Synchronize Exchange calendar information-Query the binding status of the Exchange account-Call this interface to obtain the binding status of the Exchange account, including the synchronization status of the Exchange calendar',
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        path: zod_1.z.object({
...
exports.calendarV4FreebusyList = {
    project: 'calendar',
    name: 'calendar.v4.freebusy.list',
    sdkName: 'calendar.v4.freebusy.list',
    path: '/open-apis/calendar/v4/freebusy/list',
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Calendar-Calendar management-Query availability of the primary calendar-Call this interface to query the busy/free information of the specified user's primary calendar, or to query the busy/free information of the specified meeting room",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            time_min: zod_1.z
                .string()
                .describe('The start time of the query period, in  date_time format.**Note**: The time interval between time_min and time_max cannot be more than 90 days'),
            time_max: zod_1.z
                .string()
                .describe('The end time of the query period, in  date_time format.**Note**: The time interval between time_min and time_max cannot be more than 90 days'),
            user_id: zod_1.z
                .string()
                .describe("User ID, you need to input an id that matches the query parameter user_id_type. For example, when user_id_type=open_id, you need to input the user's open_id. Refer to  for understanding user IDs.**Note**: Either user_id or room_id needs to be entered. If both are entered at the same time, only user_id will take effect")
                .optional(),
            room_id: zod_1.z
                .string()
                .describe("Meeting room room_id. You can call the  interface or the  interface to get the corresponding meeting room's room_id.**Note**: Either user_id or room_id needs to be entered. If both are entered at the same time, only user_id will take effect")
                .optional(),
            include_external_calendar: zod_1.z
                .boolean()
                .describe('Whether to include the schedule in the bound third-party calendar.**Values**：- true (default value): Include- false: Do not include')
                .optional(),
            only_busy: zod_1.z
                .boolean()
                .describe('Whether to only query busy schedule information. **Value**:- true (default): Yes, the query results do not include free schedules.- false: No, the query results include free schedules')
                .optional(),
        }),
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
...
exports.calendarV4SettingGenerateCaldavConf = {
    project: 'calendar',
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Calendar-Sync to local calendar-Generate CalDAV configuration-Call this interface to generate a CalDAV account password for the current user, which is used to synchronize Feishu calendar information to the local device calendar',
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({
            device_name: zod_1.z
                .string()
                .describe('The name of the device that needs to synchronize the calendar, which is used for display in the calendar.**Default**: empty')
                .optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.calendarV4TimeoffEventCreate = {
    project: 'calendar',
    name: 'calendar.v4.timeoffEvent.create',
    sdkName: 'calendar.v4.timeoffEvent.create',
    path: '/open-apis/calendar/v4/timeoff_events',
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Calendar-Timeoff-Create Timeoff Event-Call this interface to create a leave event for a specified user. Leave events are divided into regular events and all-day events. After creating a leave event, the user's personal signature page will display leave information during the leave time",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_id: zod_1.z
                .string()
                .describe('User ID. The ID type needs to be consistent with the value of user_id_type. For information about user IDs, see '),
            timezone: zod_1.z.string().describe('Time zone'),
            start_time: zod_1.z
                .string()
                .describe('Leave start time. Any of the following formats are supported:- Second-level timestamp: The leave event set through the timestamp is a normal event, that is, leave is requested by the hour. Value example `1609430400`- Date format: The leave event set by date is a full-day event. Value example `2021-01-01`**Note**: The time format selected for start_time and end_time must be consistent, otherwise it will be invalid'),
            end_time: zod_1.z
                .string()
                .describe('Leave end time. Any of the following formats are supported:- Second-level timestamp: The leave event set through the timestamp is a normal event, that is, leave is requested by the hour. Value example `1609430400`- Date format: The leave event set by date is a full-day event. Value example `2021-01-01`**Note**: The time format selected for start_time and end_time must be consistent, otherwise it will be invalid'),
            title: zod_1.z.string().describe('Customize the leave event title.**Default**: empty, use default title').optional(),
            description: zod_1.z
                .string()
...
exports.calendarV4TimeoffEventDelete = {
    project: 'calendar',
    ...
    httpMethod: 'DELETE',
    description: "[Feishu/Lark]-Calendar-Timeoff-Delete Timeoff Event-Call this interface to delete a specified leave event. After the leave event is deleted, the leave information on the user's personal signature page will also disappear",
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            timeoff_event_id: zod_1.z
                .string()
                .describe('Leave event ID, obtained from the returned results when creating a leave event'),
        }),
    },
};
exports.calendarV4Tools = [
    exports.calendarV4CalendarAclCreate,
    exports.calendarV4CalendarAclDelete,
    exports.calendarV4CalendarAclList,
    exports.calendarV4CalendarAclSubscription,

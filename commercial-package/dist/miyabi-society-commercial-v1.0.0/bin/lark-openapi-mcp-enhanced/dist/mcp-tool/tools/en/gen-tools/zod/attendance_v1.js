...
exports.attendanceV1ApprovalInfoProcess = {
    ...
    schema: {
        data: zod_1.z.object({
            approval_id: zod_1.z.string().describe('Approval sample ID. How to access: 1)  2)  3) '),
...
exports.attendanceV1ArchiveRuleDelReport = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            archive_rule_id: zod_1.z.string().describe('Archive rule id, which can be obtained according to '),
    ...
    schema: {
        data: zod_1.z.object({
            ...
            archive_report_datas: zod_1.z
                ...
                field_datas: zod_1.z
                    .array(zod_1.z.object({
                    code: zod_1.z.string().describe('Field code, which can be obtained according to '),
        ...
        data: zod_1.z.object({
            group: zod_1.z
                ...
                need_punch_special_days: zod_1.z
                    ...
                    shift_id: zod_1.z.string().describe('Shift ID, you can check all shifts according to And  get'),
                }))
...
exports.attendanceV1GroupDelete = {
    ...
    schema: {
        path: zod_1.z.object({
            group_id: zod_1.z.string().describe('Attendance group ID is obtained as follows: 1)  2)  3) '),
        }),
    },
};
...
exports.attendanceV1LeaveAccrualRecordPatch = {
    ...
    schema: {
        data: zod_1.z.object({
            leave_granting_record_id: zod_1.z.string().describe('The unique ID of the issuance record, which can be created by '),
            employment_id: zod_1.z.string().describe('Employee ID, type corresponding user_id_type'),
            leave_type_id: zod_1.z.string().describe('The holiday type ID can be obtained by '),
            reason: zod_1.z
                .array(zod_1.z.object({
        ...
        path: zod_1.z.object({
            leave_id: zod_1.z.string().describe('The holiday type ID can be obtained by ').optional(),
        }),
    },
};
        ...
        data: zod_1.z.object({
            ...
            flexible_rule: zod_1.z
                ...
                flexible_early_minutes: zod_1.z
                    .number()
                    .describe('You can leave early at most after get off work, unit: minutes (arrive a few minutes early at work, and leave a few minutes early after get off work)'),
                flexible_late_minutes: zod_1.z
                    .number()
                    .describe('You can arrive late at work at most, unit: minutes (arrive a few minutes late for work, and walk a few minutes late after get off work)'),
            }))
                .describe('Time setting in flexible clock')
                .optional(),
            no_need_off: zod_1.z
                .boolean()
                .describe("True is that you don't need to hit the off-duty card. The default is false, and you need to get off work clock in")
                .optional(),
            punch_time_rule: zod_1.z
                .array(zod_1.z.object({
                on_time: zod_1.z.string().describe('On time'),
                off_time: zod_1.z
                    .string()
                    .describe('Off-duty time. If off-duty time spans days, you need to accumulate time on a 24-hour basis. For example, the value of 2 am the next day is 26:00'),
                late_minutes_as_late: zod_1.z.number().describe('How late you arrive is recorded as late. unit: minutes'),
                late_minutes_as_lack: zod_1.z
                    .number()
                    .describe('How late you arrive is recorded as a missing card. Unit: minutes'),
                on_advance_minutes: zod_1.z
                    .number()
                ...
                no_need_on: zod_1.z
                    .boolean()
                    .describe("True means that you don't need to hit the work card. Special attention should be paid here. The clock in the first section must be false. You can configure it on demand later")
                    .optional(),
                no_need_off: zod_1.z
                    .boolean()
                    .describe("True means that you don't need to hit the off-duty card. The default is false, and you need to get off work clock in (the priority is higher than data.shift. no_need_off)")
                    .optional(),
            }))
                .describe('Attendance policy'),
            late_off_late_on_rule: zod_1.z
                .array(zod_1.z.object({
                late_off_minutes: zod_1.z.number().describe('How late are you walking? Unit: minutes'),
                late_on_minutes: zod_1.z.number().describe('How late are you? Unit: minute'),
            }))
            ...
            rest_time_rule: zod_1.z
                .array(zod_1.z.object({
                rest_begin_time: zod_1.z.string().describe('Break starts'),
                rest_end_time: zod_1.z.string().describe('End of break'),
            }))
                .describe('Break rule')
                .optional(),
            overtime_rule: zod_1.z
                .array(zod_1.z.object({ on_overtime: zod_1.z.string().describe('start time'), off_overtime: zod_1.z.string().describe('end time') }))
                .describe('Overtime hours (only available in Feishu Personnel Enterprise Edition)')
                .optional(),
            day_type: zod_1.z
                .number()
                .describe('Date type, when [flexible clock in = ture], cannot be set as "rest day" Optional value: 1: working day 2: rest day. Default value: 1')
                .optional(),
            overtime_rest_time_rule: zod_1.z
                .array(zod_1.z.object({
                rest_begin_time: zod_1.z.string().describe('Rest begins'),
                rest_end_time: zod_1.z.string().describe('Break is over'),
            }))
                .describe('Out-of-class break rules')
                .optional(),
            late_minutes_as_serious_late: zod_1.z
                .number()
                .describe('How late is recorded as a serious late. unit: minutes (priority is higher than data.shift. punch_time_rule late_minutes_as_serious_late)')
                .optional(),
            shift_middle_time_rule: zod_1.z
                .object({
                middle_time_type: zod_1.z
                    .number()
                    .describe('Half-day split type Options:0(DefaultWithRest Split by the midpoint of the full-day shift duration (including breaks)),1(DefaultWithoutRest Split by the midpoint of the full-day shift duration (excluding breaks)),2(BaseInRest Split by break time),3(BaseInFixed Split by fixed point in time)')
                    .optional(),
                fixed_middle_time: zod_1.z.string().describe('Fixed split time point (effective middle_time_type 3)').optional(),
            })
                .describe('Half-day split rules (available only in Feishu Personnel Enterprise Edition)')
                .optional(),
            shift_attendance_time_config: zod_1.z
                .object({
                attendance_time: zod_1.z.number().describe('due time').optional(),
                on_attendance_time: zod_1.z.number().describe('Duration of attendance in the first half of the day').optional(),
                off_attendance_time: zod_1.z.number().describe('Duration of attendance in the second half of the day').optional(),
            })
            ...
            late_off_late_on_setting: zod_1.z
                ...
                late_off_base_on_time_type: zod_1.z
                    .number()
                    .describe('Rules for calculating the departure time of the same day Options:0(FlexibleType Elastic rule),1(FixedType fixed rule)')
                    .optional(),
                late_on_base_on_time_type: zod_1.z
                    .number()
                    .describe('Next day late arrival time calculation rules Options:0(FixedType fixed rule),1(FlexibleType Elastic rule)')
                    .optional(),
            })
                .describe('Late departure, late arrival the next day, configuration rules')
                .optional(),
            id: zod_1.z.string().describe('Shift id (need to pass when updating shift), get method: 1)  2) ').optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
...
exports.attendanceV1ShiftDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Delete Attendance Shift-Delete the shift by the shift ID. The corresponding function is the Delete button in the operation bar in the shift list of false attendance settings - [shift settings] (https://example.feishu.cn/people/workforce-management/setting/group/shifts)',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            shift_id: zod_1.z.string().describe('Shift ID, which can be obtained as follows: 1)  2) '),
        }),
    },
};
exports.attendanceV1ShiftGet = {
    ...
    path: '/open-apis/attendance/v1/shifts/:shift_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query shifts by ID-Get the shift details through the shift ID. The corresponding function is fake duty settings -  The specific shift in the shift list, the shift information can be viewed by clicking the shift name',
    accessTokens: ['tenant'],
    schema: {
        path: zod_1.z.object({
            shift_id: zod_1.z.string().describe('Shift ID, which can be obtained as follows: 1)  2) '),
...
exports.attendanceV1ShiftList = {
    ...
    path: '/open-apis/attendance/v1/shifts',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query all shifts-Fake duty settings in Feishu personnel management background -  page turn query all shift functions, showing shift name, clock in rules, flexible shift rules, rest rules, etc',
    accessTokens: ['tenant'],
    schema: {
        params: zod_1.z.object({
            page_size: zod_1.z.number().describe('paging size').optional(),
...
exports.attendanceV1ShiftQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance shift-Query Attendance Shift by Name-Feishu personnel management background fake work settings -  in the search shift name function, showing shift name, clock in rules, flexible shift rules, rest rules, etc',
    accessTokens: ['tenant'],
    schema: {
        params: zod_1.z.object({ shift_name: zod_1.z.string().describe('Shift name, support fuzzy matching') }),
    },
};
    ...
    schema: {
        data: zod_1.z.object({
            user_approval: zod_1.z
                ...
                date: zod_1.z.string().describe('Approval date in the format yyyMMdd'),
                outs: zod_1.z
                    .array(zod_1.z.object({
                    uniq_id: zod_1.z
                        .string()
                        .describe('Outgoing type unique ID, representing an outgoing type, with a length less than 14* How to get it? You can choose to fill in the outgoing type id of the three parties. Such as the id of going out in the city and going out outside the city'),
                    unit: zod_1.z
                        .number()
                        .describe('Unit of time spent away Options:1(Day),2(Hour),3(HalfDay Half day),4(HalfHour Half hour)'),
                    interval: zod_1.z
                        .number()
                        .describe('The time for the associated approval form to go out, the unit is seconds, and it has nothing to do with the unit'),
                    start_time: zod_1.z.string().describe('Start time, time format is yyyy-MM-dd HH:mm:ss'),
                    end_time: zod_1.z.string().describe('End time, time format is yyyy-MM-dd HH:mm:ss'),
                    i18n_names: zod_1.z
                        .object({
                        ch: zod_1.z.string().describe('Chinese description').optional(),
                        en: zod_1.z.string().describe('English description').optional(),
                        ja: zod_1.z.string().describe('Japanese description').optional(),
                    })
                        .describe('Out of office multi-language present, with the format is map, and the key is ["ch", "en", "ja"], where ch stands for Chinese, en stands for English, ja stands for Japanese'),
                    default_locale: zod_1.z
                        .string()
                        .describe('Default language type. Since Chinese, English, and Japanese are available on Feishu apps, when user switches language, if there is no corresponding language name, it will use the name of default language'),
                    reason: zod_1.z.string().describe('Out of office reason'),
                    idempotent_id: zod_1.z
                        .string()
                        .describe('The unique idempotent key of the outgoing record, which is used to avoid repeated creation of the outgoing record. You can fill in the outgoing record id of the three parties')
                        .optional(),
                    correct_process_id: zod_1.z
                        .array(zod_1.z.string())
                        .describe('Correct process instance ID.This field is automatically generated by the system and should not be included when submitting approval results')
                        .optional(),
                    cancel_process_id: zod_1.z
                        .array(zod_1.z.string())
                        .describe('Revoke process instance ID.This field is automatically generated by the system and should not be included when submitting approval results')
                        .optional(),
                    process_id: zod_1.z
                        .array(zod_1.z.string())
                        .describe('initiating process instance ID.This field is automatically generated by the system and should not be included when submitting approval results')
                        .optional(),
                }))
                ...
                leaves: zod_1.z
                    ...
                    uniq_id: zod_1.z
                        .string()
                        .describe('Vacation type unique ID, representing a vacation type, less than 14 in length* This ID corresponds to the holiday type (ie: i18n_names), so it needs to be guaranteed to be unique. You can get ')
                        .optional(),
                    unit: zod_1.z
                        .number()
                    ...
                    interval: zod_1.z
                        .number()
                        .describe('The holiday duration of the associated approval order is seconds, which has nothing to do with unit'),
                    start_time: zod_1.z.string().describe('Start time, time format is yyyy-MM-dd HH:mm:ss'),
                    end_time: zod_1.z.string().describe('End time, time format is yyyy-MM-dd HH:mm:ss'),
                    i18n_names: zod_1.z
                        .object({
                        ...
                        .describe('Leave multi-language present, with the format is map, and the key is ["ch", "en", "ja"], where ch stands for Chinese, en stands for English, ja stands for Japanese'),
                    default_locale: zod_1.z
                        .enum(['ch', 'en', 'ja'])
                        .describe('Default language type. Since Chinese, English, and Japanese are available on Feishu apps, when user switches language, if there is no corresponding language name, it will use the name of default language Options:ch(Chinese description),en(English description),ja(Japanese description)'),
                    reason: zod_1.z.string().describe('Leave reason'),
                    idempotent_id: zod_1.z
                        .string()
                        .describe('The unique idempotent key of the leave record, which is used to avoid repeated creation of leave records. You can fill in the leave record id of the three parties')
                        .optional(),
                }))
                    .describe('Leave info')
                    .optional(),
                overtime_works: zod_1.z
                    ...
                    duration: zod_1.z
                        .number()
                        .describe('If you need to use this field to calculate overtime hours, please contact  to open. start_time and end_time calculation are used by default'),
                    unit: zod_1.z
                        .number()
                    ...
                    type: zod_1.z
                        .number()
                        .describe('Overtime rule type Options:0(None record only),1(DaysOff Counted as compensatory leave),2(Fee Counted as overtime pay),3(Bind [This optional value has been deprecated])'),
                    start_time: zod_1.z.string().describe('Start time, time format is yyyy-MM-dd HH:mm:ss'),
                    end_time: zod_1.z.string().describe('End time, time format is yyyy-MM-dd HH:mm:ss'),
                    reason: zod_1.z.string().describe('overwork reason').optional(),
                    idempotent_id: zod_1.z
                        .string()
                        .describe('The unique idempotent key for overtime records, which is used to avoid repeated creation of overtime records. You can fill in the overtime record id of the three parties')
                        .optional(),
                    correct_process_id: zod_1.z
                        .array(zod_1.z.string())
                        .describe('Correct process instance ID.This field is automatically generated by the system and should not be included when submitting approval results')
                ...
                trips: zod_1.z
                    ...
                    start_time: zod_1.z.string().describe('Start time, time format is yyyy-MM-dd HH:mm:ss'),
                    end_time: zod_1.z.string().describe('End time, time format is yyyy-MM-dd HH:mm:ss'),
                    reason: zod_1.z.string().describe('Business trip reason'),
                    approve_pass_time: zod_1.z.string().describe('Approved time, time format is yyyy-MM-dd HH:mm:ss'),
                    approve_apply_time: zod_1.z.string().describe('Application time, time format is yyyy-MM-dd HH:mm:ss'),
                    idempotent_id: zod_1.z
                        .string()
                        .describe('The unique idempotent key of the business trip record, which is used to avoid repeated creation of business trip records. You can fill in the business trip record id of the three parties')
                        .optional(),
                    correct_process_id: zod_1.z
                        .array(zod_1.z.string())
                        .describe('Correct process instance ID.This field is automatically generated by the system and should not be included when submitting approval results')
                    ...
                    departure: zod_1.z
                        ...
                        region_level: zod_1.z
                            .string()
                            .describe('Geographical level (country | province | city | district)l1: Countryl2: Provincel3: Cityl4: District/County')
                            .optional(),
                        region_id: zod_1.z
                            .string()
                            .describe('Geographic ID, it can be obtained by  or  (only supported by Feishu People Enterprise)')
                            .optional(),
                    })
                    ...
                    transportation: zod_1.z
                        ...
                        .optional(),
                    trip_type: zod_1.z.number().describe('Business trip type (1: one way 2: round trip)').optional(),
                    remarks: zod_1.z.string().describe('Business trip remarks').optional(),
                }))
                    .describe('Travel information.Currently only full-day travel is supported (less than full days are counted as full days). If you need to support half-day travel, please consult ')
                    .optional(),
                time_zone: zod_1.z
                    .string()
                    .describe('This field is no longer used, subject to the time zone of the attendance group matched by the user')
                    .optional(),
            })
...
exports.attendanceV1UserApprovalQuery = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Attendance-Attendance approval-Get approval data-This interface is used to get granted approval data of employees' leave, overtime, out of office and business trip over a certain period of time",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('employee_no or employee_id list. The ID type passed in needs to match the value of the employee_type'),
            check_date_from: zod_1.z
                .number()
                .describe('The start date of the query. Format yyyyMMdd**Note**: The date passed in cannot exceed the current day + 1 day. For example, if the current day is 20241010, then passing in 20241011 will support query, but passing in 20241012 will result in an error'),
            check_date_to: zod_1.z
                .number()
            ...
            check_date_type: zod_1.z
                ...
                .describe('The time type of the query basis (do not fill in the default basis PeriodTime) Options:PeriodTime(Document duration (i.e. remedy_time)),CreateTime(Document creation time),UpdateTime(Document status update time (grey release, not yet open))')
                .optional(),
            status: zod_1.z
                .number()
                .describe('Query status (no default query passed status)Leave and overtime: Only support Approved and Revoked statusesOuting and business trip: Support querying all statuses Options:0(Todo Pending),1(Rejected),2(Approved),3(Canceled Cancelled),4(Reverted Revoked)')
                .optional(),
            check_time_from: zod_1.z
                .string()
                .describe('The start time of the query, accurate to the second timestamp (in grayscale)')
                .optional(),
            check_time_to: zod_1.z
                .string()
...
exports.attendanceV1UserDailyShiftBatchCreate = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Attendance-Attendance schedule-Create or modify schedule-The schedule is used to describe which shift the personnel in the attendance group go to work every day. Currently, the schedule supports scheduling one or more personnel by x month y day. It will be created when the user's schedule data does not exist, and will be modified according to the imported parameter information when the user's schedule data exists. Note: Each person can only be in one attendance group per day",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_daily_shifts: zod_1.z
                ...
                month: zod_1.z.number().describe('Month, format yyyyMM'),
                user_id: zod_1.z.string().describe('User ID, corresponding to employee_type'),
                day_no: zod_1.z.number().describe('Date'),
                is_clear_schedule: zod_1.z
                    .boolean()
                    .describe('Whether to clear the shift (this field takes precedence over shift_id, if true, shift_id will be invalid)')
                    .optional(),
            }))
                .describe('Schedule information list (quantity limit within 50)'),
            operator_id: zod_1.z
                .string()
                .describe('Operator uid, corresponding to employee_type. If you do not operate [backstage for attendance management "API access" process] (/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attachment-v1/attendance-development-guidelines), this field is required')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
    ...
    schema: {
        data: zod_1.z.object({
            user_tmp_daily_shifts: zod_1.z
                ...
                group_id: zod_1.z.string().describe('Attendance group ID is obtained as follows: 1)  2)  3) '),
                user_id: zod_1.z.string().describe('User ID, corresponding to employee_type'),
                date: zod_1.z.number().describe('date'),
                shift_name: zod_1.z.string().describe('shift name'),
                punch_time_simple_rules: zod_1.z
                    .array(zod_1.z.object({
                    on_time: zod_1.z.string().describe('On-duty time, format HH: MM'),
                    off_time: zod_1.z
                        .string()
            ...
            operator_id: zod_1.z
                .string()
                .describe('Operator uid, corresponding to employee_type. If you do not operate the backstage for attendance management "API access" process, this field is required')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
...
exports.attendanceV1UserDailyShiftQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance schedule-Query schedule information-Support querying the scheduling of multiple users. Note that this interface returns the scheduling results of the user dimension, which does not correspond to the page function. You can query the attendance group [query the attendance group by ID] (/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attachment-v1/group/get) through the group_id in the return result, shift_id query the shift [query the shift by ID] (/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/reference/attachment-v1/shift/get). The time span of the query cannot exceed 30 days',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_ids: zod_1.z
            ...
            check_date_from: zod_1.z.number().describe('The starting working day of the query, in the format yyyMMdd'),
            check_date_to: zod_1.z.number().describe('The closing working day of the query, in the format yyyMMdd'),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
...
exports.attendanceV1UserFlowBatchCreate = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Attendance-Attendance records-Import attendance record-Import the employee's attendance details. After importing, the final clock in status and result will be calculated according to the shift rules of the employee's attendance team. You can check in clock in management - [clock in records] (https://example.feishu.cn/people/workforce-management/manage/statistics/flow)",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            flow_records: zod_1.z
                .array(zod_1.z.object({
                user_id: zod_1.z.string().describe('User ID. Corresponds to employee_type'),
                creator_id: zod_1.z.string().describe('Record creator ID. Corresponds to employee_type'),
                location_name: zod_1.z.string().describe('Attendance location name information'),
                check_time: zod_1.z
                    .string()
                    .describe('Clock in time, timestamp accurate to seconds (only data with clock in time after January 1, 2022 is supported)'),
                comment: zod_1.z.string().describe('Attendance note'),
                record_id: zod_1.z.string().describe('Attendance record ID').optional(),
                ssid: zod_1.z.string().describe('SSID of attendance Wi-Fi').optional(),
                bssid: zod_1.z.string().describe('MAC address of attendance Wi-Fi').optional(),
                is_field: zod_1.z
                    .boolean()
                ...
                check_result: zod_1.z
                    ...
                    .describe('Clock in effect as an imported parameter Options:NoNeedCheck(No clock in),SystemCheck(System clock in),Normal(Normal),Early(Leave early),Late(Late),SeriousLate(Seriously late),Lack(Missing card),Invalid(Invalid),None(Stateless),Todo(Not clocked in yet)')
                    .optional(),
                external_id: zod_1.z
                    .string()
                    .describe("The record ID of the external clock in the user's import is used for comparison with the external data. If it is not passed, it is inconvenient to distinguish when querying")
                    .optional(),
                idempotent_id: zod_1.z
                    .string()
...
exports.attendanceV1UserFlowBatchDel = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance records-delete attendance record-Delete the clock in record imported by the employee from the open platform. After deletion, the clock in record will be recalculated corresponding to the attendance task result',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            record_ids: zod_1.z.array(zod_1.z.string()).describe('Attendance flow record ID, which is obtained as follows: 1)  2)  3) '),
        }),
    },
};
...
exports.attendanceV1UserFlowQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            user_ids: zod_1.z.array(zod_1.z.string()).describe('employee_no or employee_id list, with length of no more than 50'),
            check_time_from: zod_1.z.string().describe('The start time of the query, in seconds timestamp'),
            check_time_to: zod_1.z.string().describe('Query end time, second timestamp'),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
    ...
    schema: {
        data: zod_1.z.object({
            user_setting: zod_1.z
                ...
                face_key: zod_1.z.string().describe('Face photo file ID, get method: '),
                face_key_update_time: zod_1.z
                    .string()
...
exports.attendanceV1UserSettingQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            user_ids: zod_1.z.array(zod_1.z.string()).describe('employee_no or employee_id list, corresponding to employee_type'),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
...
exports.attendanceV1UserStatsDataQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance statistics-Query statistical data-Query statistics for daily or monthly statistics. Fields contain basic information, attendance group information, attendance statistics, exception statistics, leave statistics, overtime statistics, clock in time, attendance results, and custom fields. Specific reports can be found in Attendance Statistics - ',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            locale: zod_1.z.enum(['en', 'ja', 'zh']).describe('Language Options:en(English),ja(Japanese),zh(Chinese)'),
            stats_type: zod_1.z
                .enum(['daily', 'month'])
                .describe('Statistics type Options:daily(Daily statistics),month(Monthly statistics)'),
            start_date: zod_1.z.number().describe('Start time, format yyyyMMdd'),
            end_date: zod_1.z.number().describe('End time, format yyyyMMdd(The time interval does not exceed 31 days)'),
            user_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('List of queried user IDs, corresponding to employee_type(No more than 200 users)* Required fields (all have been upgraded to the new system, new system requirements are required)')
                .optional(),
            need_history: zod_1.z
                .boolean()
                .describe('Whether to include departing personnel and transferring personnel, the default is false and not included')
                .optional(),
            current_group_only: zod_1.z
                .boolean()
                .describe("* 'true': only show the attendance group data to which the employee currently belongs* 'false': Show all employee attendance group data < br > Default value: false")
                .optional(),
            user_id: zod_1.z
                .string()
                .describe("Operator's user_id. Corresponds to employee_type* Each report of different operators (administrators) may have different field settings, and the system will query the statistics of the specified report according to the user_id.Required field (all have been upgraded to the new system, and the new system requires this field to be filled in)")
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
    ...
    schema: {
        data: zod_1.z.object({
            ...
            stats_type: zod_1.z
                .enum(['daily', 'month'])
                .describe('Statistics type Options:daily(Daily statistics),month(Monthly statistics)'),
            start_date: zod_1.z.number().describe('Start time in the format yyyMMdd'),
            end_date: zod_1.z.number().describe('End time in the format yyyMMdd (no more than 40 days apart)'),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
...
exports.attendanceV1UserStatsViewQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            user_id: zod_1.z
                .string()
                .describe('User ID of the operator, corresponding to employee_type* Required fields (required for new system requirements after system upgrade)')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
...
exports.attendanceV1UserStatsViewUpdate = {
    ...
    httpMethod: 'PUT',
    description: '[Feishu/Lark]-Attendance-Attendance statistics-Update statistics settings-Update the statistical report header setting information customized by the developer for daily statistics or monthly statistics. The header information of the report can be found in the attendance statistics - . This interface is specially used to update the header information',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            view: zod_1.z
                .object({
                view_id: zod_1.z.string().describe('View ID'),
                stats_type: zod_1.z
                    .enum(['daily', 'month'])
                    .describe('View type Options:daily(Daily statistics),month(Monthly statistics)'),
                user_id: zod_1.z.string().describe('User ID of the operator, corresponding to employee_type'),
                items: zod_1.z
                    .array(zod_1.z.object({
                    code: zod_1.z.string().describe('Title number'),
                    child_items: zod_1.z
                        .array(zod_1.z.object({
                        code: zod_1.z.string().describe('Subtitle number'),
                        value: zod_1.z.string().describe('Switch field, 0: off, 1: on'),
                    }))
                        .describe('Subtitle')
                        .optional(),
                }))
        ...
        path: zod_1.z.object({
            user_stats_view_id: zod_1.z.string().describe('User view ID is obtained as follows: 1) '),
        }),
    },
};
exports.attendanceV1UserTaskRemedyCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Attendance-Attendance correction-Notify correction approval initiation-For enterprises that only use Fishu attendance system but not Fishu approval system, you can use this interface to write the replacement card approval data initiated in the three-party approval system to Fishu attendance system with the status of approval in progress. The status can be updated by  after writing in',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_id: zod_1.z.string(),
            remedy_date: zod_1.z.number().describe('Replenishment date, date format yyyyMMdd'),
            punch_no: zod_1.z
                .number()
                .describe('The punch in/off No., 0: the first punch in/off, 1: the second punch in/off, 2: the third punch in/off, and fill in 0 for free shift'),
            work_type: zod_1.z.number().describe('On duty/off duty, 1: on duty, 2: off duty, and fill in 0 for free shift'),
            remedy_time: zod_1.z.string().describe('Correction time in the format of yyyy-MM-dd HH:mm'),
            reason: zod_1.z.string().describe('Correction reason'),
            time: zod_1.z.string().describe('Field is invalid').optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])
...
exports.attendanceV1UserTaskRemedyQuery = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Attendance-Attendance correction-Obtain correction record-Supplementary card: The user adds a clock in record within the time frame of a certain commute/get off work by means of approval to correct the user's attendance result. This interface is dedicated to obtaining the supplementary card records of employees (no page function corresponds)",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('employee_no or employee_id list. The ID type passed in needs to match the value of the employee_type. Up to 50 are supported'),
            check_time_from: zod_1.z.string().describe('The start time of the check, with the timestamp accurate to seconds'),
            check_time_to: zod_1.z.string().describe('The end time of the check, with the timestamp accurate to seconds'),
            check_date_type: zod_1.z
                .enum(['PeriodTime', 'CreateTime', 'UpdateTime'])
                .describe('The time type of the query basis (do not fill in the default basis PeriodTime) Options:PeriodTime(Document duration (i.e. remedy_time)),CreateTime(Document creation time),UpdateTime(Document status update time (new fields, effective for specific tenants))')
                .optional(),
            status: zod_1.z
                .number()
                .describe('Query status (no default query passed status) Options:0(Pending),1(Rejected),2(Pass),3(Cancel),4(Withdraw)')
                .optional(),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
...
exports.attendanceV1UserTaskRemedyQueryUserAllowedRemedys = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Attendance-Attendance correction-Obtain the time allowing for user's correction-Obtains the number of punch in/off the user can correct for a given day",
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            user_id: zod_1.z.string().describe('User ID, corresponding employee_type'),
            remedy_date: zod_1.z.number().describe('Replenishment date in yyyyMMdd format'),
        }),
        params: zod_1.z.object({
            employee_type: zod_1.z
                .enum(['employee_id', 'employee_no'])

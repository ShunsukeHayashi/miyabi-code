    ...
    schema: {
        data: zod_1.z.object({
            file_extension: zod_1.z
                ...
                .describe('The file extension of the local file after exporting the cloud document. To understand the file formats supported for exporting various cloud documents, refer to the . Options:docx(Microsoft Word (DOCX) format),pdf(PDF format),xlsx(Microsoft Excel (XLSX) format),csv(CSV format)'),
            token: zod_1.z.string().describe('The token of the cloud document. For details, see '),
            type: zod_1.z
...
exports.driveV1ExportTaskGet = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            ticket: zod_1.z.string().describe('Export task ID, call  to get the ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentBatchQuery = {
    ...
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({ comment_ids: zod_1.z.array(zod_1.z.string()).describe('Comment ID list') }),
        params: zod_1.z.object({
            file_type: zod_1.z
                .enum(['doc', 'docx', 'sheet', 'file', 'slides'])
                .describe('Document type Options:doc(docsheetdocxfile),docx(Upgraded Docs),sheet(Form),file(File),slides(Slides)'),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        }),
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('Document token').optional() }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentCreate = {
    ...
    schema: {
                    ...
                    content: zod_1.z
                        ...
                        elements: zod_1.z
                            ...
                            type: zod_1.z
                                ...
                                .describe('Content elements of the reply Options:text_run(Plain text),docs_link(Link to @mentioning a document in Docs),person(Contact to @mention)'),
                            text_run: zod_1.z
                                .object({ text: zod_1.z.string().describe('Reply with plain text') })
                                .describe('Text content')
                                .optional(),
                            docs_link: zod_1.z
                                .object({ url: zod_1.z.string().describe('@mentioned document in a reply') })
                                .describe('Text content')
                                .optional(),
                            person: zod_1.z
                                .object({ user_id: zod_1.z.string().describe('@mentioned contact in a reply') })
                                .describe('Text content')
                                .optional(),
                        }))
        ...
        params: zod_1.z.object({
            file_type: zod_1.z.enum(['doc', 'docx']).describe('Type of the document Options:doc(Doc),docx(New Doc)'),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        }),
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('Token of the document') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Comment-Get a whole comment-Obtains a specified global comment in Docs. Local comments are not supported yet',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            file_type: zod_1.z
        ...
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Token of the document'),
            comment_id: zod_1.z.string().describe('Comment ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentList = {
    ...
    schema: {
        params: zod_1.z.object({
            file_type: zod_1.z
                .enum(['doc', 'docx', 'sheet', 'file', 'slides'])
                .describe('Type of the document Options:doc(Doc),docx(Upgraded Docs),sheet(Sheet),file(File in My Space),slides(Slides)'),
            is_whole: zod_1.z.boolean().describe('Whether whole comment').optional(),
            is_solved: zod_1.z.boolean().describe('Specifies whether the comment is solved. This field is optional').optional(),
            page_token: zod_1.z
                .string()
...
exports.driveV1FileCommentPatch = {
    ...
    path: '/open-apis/drive/v1/files/:file_token/comments/:comment_id',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Docs-Comment-Solve or Restore a Comment-Solves or restores a comment on a document in Docs',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({ is_solved: zod_1.z.boolean().describe('Icon that indicates whether the comment is solved') }),
        params: zod_1.z.object({
            file_type: zod_1.z
                .enum(['doc', 'docx', 'sheet', 'file', 'slides'])
...
exports.driveV1FileCommentReplyDelete = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Token of the document'),
            comment_id: zod_1.z.string().describe('Comment ID'),
            reply_id: zod_1.z.string().describe('Reply ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCommentReplyList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Comment-Get Replies List-This interface is used to obtain replies according to the comment ID and pagination parameters',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            page_size: zod_1.z.number().optional(),
        ...
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Document Token'),
            comment_id: zod_1.z.string().describe('Comment ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1FileCopy = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Docs-Space-File-Copy File-Copy a file to a different folder in the user's Space. Folders cannot be copied. This interface is asynchronous",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            name: zod_1.z.string().describe('The new name of the copied file.**Data validation rules**: Maximum length: 256 bytes'),
            type: zod_1.z
                .enum(['file', 'doc', 'sheet', 'bitable', 'docx', 'mindnote', 'slides'])
                .describe('File type that need to be copied. This parameter is required. If the value is empty or does not match the actual file type, the interface will return failure. Options:file(Common file type),doc(Cloud document type of docs),sheet(Cloud document type of sheet),bitable(Cloud document type of bitable),docx(Cloud document type of upgraded docs),mindnote(Cloud document type of mindnote),slides(Cloud document type of slide)')
                .optional(),
            ...
            extra: zod_1.z
                .array(zod_1.z.object({
                key: zod_1.z.string().describe('Custom property key'),
                value: zod_1.z.string().describe('Custom property value'),
            }))
...
exports.driveV1FileCreateFolder = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Docs-Space-Folder-Create Folder-Creates a new empty folder within the specified parent folder in the user's Space",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            name: zod_1.z.string().describe('The name of the folder you wish to create.**Length limit**: 1~256 bytes'),
            folder_token: zod_1.z
                .string()
                .describe('Parent folder token. This parameter can be an empty string, which means the folder will be created in the root folder. You can refer to  to get other level folder. For details, see '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileCreateShortcut = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Space-File-Create file shortcut-Create shortcut to specified Docs in other folders in Space',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            parent_token: zod_1.z
                .string()
                .describe('The token of the target folder into which the file is copied. For how to get the folder token, see '),
            refer_entity: zod_1.z
                ...
                refer_type: zod_1.z
                    ...
                    .describe('File type that need to be copied. If the value is empty or does not match the actual file type, the interface will return failure. Options:file(File),docx(Upgraded Docs),bitable(Bitable),doc(Docs),sheet(Sheets),mindnote(MindNotes),slides(Slides)'),
            })
...
exports.driveV1FileDelete = {
    ...
    httpMethod: 'DELETE',
    description: "[Feishu/Lark]-Docs-Space-File-Delete file or folder-Delete a file or folder from user's Space. After the file or folder is deleted, it will go to the user's recycle bin",
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['file', 'docx', 'bitable', 'folder', 'doc', 'sheet', 'mindnote', 'shortcut', 'slides'])
                .describe('File type that need to be deleted. Options:file(Common file type),docx(Cloud document type of upgraded docs),bitable(Cloud document type of bitable),folder(Folder type),doc(Cloud document type of docs),sheet(Cloud document type of sheet),mindnote(Cloud document type of mindnote),shortcut(Shortcut type),slides(Cloud document type of slide)'),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z
                .string()
                .describe("File's or folder's token that needs to be moved.To learn how to get the file token, see .To learn how to get the folder token, see ")
                .optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
    ...
    schema: {
        params: zod_1.z.object({
            file_type: zod_1.z
                ...
                .describe('Document type Options:doc(Depracated version of document),docx(Upgraded Docs),sheet(Spreadsheet),bitable(Bitable),file(File),folder(Folder),slides(Slides)'),
            event_type: zod_1.z
                .string()
                .describe('Event type, required when subscribing to the folder type and required to be `file.created_in_folder_v1`')
                .optional(),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Document token. For details, see '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1FileList = {
    ...
    httpMethod: 'GET',
    description: "[Feishu/Lark]-Docs-Space-Folder-List items in folder-Get the list of files under the specified folder in the user's cloud space. List item types include files, various online documents (doc, sheet, bitable, mindnote), and folders",
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            page_size: zod_1.z.number().optional(),
            ...
            folder_token: zod_1.z
                .string()
                .describe("Folder's token. (If this parameter is not provided or an empty string is provided, then return the list of the user's cloud space)")
                .optional(),
            order_by: zod_1.z
                .enum(['EditedTime', 'CreatedTime'])
                .describe('Options:EditedTime(Order by edited time),CreatedTime(Order by created time)')
                .optional(),
            direction: zod_1.z.enum(['ASC', 'DESC']).describe('Options:ASC(Ascending order),DESC(Descending order)').optional(),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1FileMove = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Docs-Space-File-Move a file or folder-Move a file or folder to a different location in the user's Space",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            type: zod_1.z
                .enum(['file', 'docx', 'bitable', 'doc', 'sheet', 'mindnote', 'folder', 'slides'])
                .describe('File type. If the value is empty or does not match the actual file type, the interface will return failure. Options:file(Common file type),docx(Cloud document type of upgraded docs),bitable(Cloud document type of bitable),doc(Cloud document type of docs),sheet(Cloud document type of sheet),mindnote(Cloud document type of mindnote),folder(Folder type),slides(Cloud document type of slide)')
                .optional(),
            folder_token: zod_1.z.string().describe('Target folder token. To learn how to get the folder token, see ').optional(),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z
                .string()
...
exports.driveV1FileStatisticsGet = {
    ...
    httpMethod: 'GET',
    description: "[Feishu/Lark]-Docs-Space-File-Obtain file's statistics-This API is used to obtain file's statistics, including the number of unique visitors (UVs), the number of page views (PVs), and the number of likes",
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            file_type: zod_1.z
                .enum(['doc', 'sheet', 'mindnote', 'bitable', 'wiki', 'file', 'docx'])
                .describe('File type Options:doc(Docs),sheet(Sheet),mindnote(MindNotes),bitable(Bitable),wiki(Wiki),file(File),docx(Upgraded Docs)'),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('File token. For details, see ').optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1FileSubscriptionCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Docs Assistant-Subscription-Create Subscription-Subscribe to change events in the document, currently supporting document comment subscriptions',
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({
            subscription_id: zod_1.z.string().describe('subsription id').optional(),
            subscription_type: zod_1.z
                .literal('comment_update')
                .describe('subscription type Options:comment_update(subscribe comment)'),
            is_subcribe: zod_1.z.boolean().describe('Whether to subscribe').optional(),
            file_type: zod_1.z
                .enum(['doc', 'docx', 'wiki'])
                .describe('document type Options:doc(Doc),docx(Upgraded Docs),wiki(Wiki)'),
        }),
        path: zod_1.z.object({ file_token: zod_1.z.string().describe('file token') }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileSubscriptionGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Docs Assistant-Subscription-Get subscription status-Get the status of the subscription based on the subscription ID',
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({
            file_type: zod_1.z.enum(['doc', 'docx', 'wiki']).describe('file type Options:doc(Docs),docx(Upgraded Docs),wiki(Wiki)'),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('file token').optional(),
            subscription_id: zod_1.z.string().describe('Subscription ID').optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileSubscriptionPatch = {
    ...
    path: '/open-apis/drive/v1/files/:file_token/subscriptions/:subscription_id',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Docs-Docs Assistant-Subscription-update subscription status-Update subscription status based on subscription ID',
    accessTokens: ['user'],
    schema: {
        data: zod_1.z.object({
            is_subscribe: zod_1.z.boolean().describe('Whether to subscribe'),
            file_type: zod_1.z.enum(['doc', 'docx', 'wiki']).describe('file type Options:doc(Doc),docx(Upgraded Docs),wiki(Wiki)'),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('File token').optional(),
            subscription_id: zod_1.z.string().describe('Subscription ID').optional(),
...
exports.driveV1FileTaskCheck = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Space-Folder-Query Task Status-Query the status information of asynchronous tasks. Currently supports moving and deleting folder tasks',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            task_id: zod_1.z.string().describe('File-related asynchronous `task_id`. See  or  to get the `task_id`'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileUploadFinish = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-File-Upload files-Multipart Upload-Upload a file in blocks-Completing-Completes an upload task',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            upload_id: zod_1.z.string().describe('ID of the block upload transaction. You can call the  to get the upload ID'),
            block_num: zod_1.z.number().describe('Number of blocks. You can call the  to get the number of blocks'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileUploadPrepare = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-File-Upload files-Multipart Upload-Upload a file in blocks-Pre­uploading-Send an initialization request to obtain the upload ID and split strategy, preparing for . The platform consistently chunks files into 4MB segments. To understand the complete file upload process, refer to ',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            file_name: zod_1.z.string().describe('File name'),
            parent_type: zod_1.z
                .literal('explorer')
                .describe('Type of the upload point. Fixed as "explorer", which means to upload files into the cloud space. Options:explorer(My Space.)'),
            parent_node: zod_1.z.string().describe('Token of the folder. For details, see '),
            size: zod_1.z.number().describe('File size. The units are in bytes'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileVersionCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Space-Document Version-Create document version-Create a document version based on the existing document. The document supports Feishu document and spreadsheet. This interface is asynchronous',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            name: zod_1.z
                .string()
                .describe('The title of the new version of the document. The maximum length is 1024 Unicode code points. Generally, one English or Chinese character corresponds to one code point, but some special symbols may correspond to multiple code points. For example, the family combo "👨‍👩‍👧" this emoji corresponds to 5 code points.**Note**:This parameter is required, please ignore the "No" displayed in the required column on the left')
                .optional(),
            obj_type: zod_1.z
                .enum(['docx', 'sheet'])
                .describe('Document version type. **Note**:This parameter is required, please ignore the "No" displayed in the required column on the left. Options:docx(Upgraded Docs),sheet(Spreadsheet)')
                .optional(),
        }),
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Document token. For how to get the document token, see '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileVersionDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Docs-Space-Document Version-Delete document version-Delete document version. The document supports Feishu document and spreadsheet',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            obj_type: zod_1.z
        ...
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('Document token. For how to get the document token, see '),
            version_id: zod_1.z.string().describe('document version ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileVersionGet = {
    ...
    path: '/open-apis/drive/v1/files/:file_token/versions/:version_id',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Space-Document Version-Get document version-Get document version. The document can be Feishu document or spreadsheet. The version information includes the version title, version ID, version creator, create time, and more',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            obj_type: zod_1.z
...
exports.driveV1FileVersionList = {
    ...
    path: '/open-apis/drive/v1/files/:file_token/versions',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Space-Document Version-List document version-Get all versions of the document. The document can be Feishu document or spreadsheet',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            ...
            page_token: zod_1.z
                ...
                .describe('Page identifier. It is not filled in the first request, indicating traversal from the beginning; when there will be more groups, the new page_token will be returned at the same time, and the next traversal can use the page_token to get more groups')
                .optional(),
            obj_type: zod_1.z.enum(['docx', 'sheet']).describe('document type Options:docx(Upgraded Docs),sheet(Spreadsheet)'),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional(),
        }),
        path: zod_1.z.object({
            file_token: zod_1.z.string().describe('parent document token. For how to get the document token. see '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1FileViewRecordList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Space-File-Obtain document view records-Obtain the view records of files, including document, sheet, base, wiki, and more. The view records contains the ID, profile, and last view time of the viewers',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
...
exports.driveV1ImportTaskCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            file_extension: zod_1.z
                .string()
                .describe('The extension of the file to be imported. To learn about supported file formats, refer to .**Note**: The file extensions filled in here need to be strictly consistent with the suffixes of the actual files. Please be careful to distinguish Markdown files with suffixes ‘markdown’, ‘md’, ‘mark’, and keep the suffixes consistent when you fill in the relevant parameters. Otherwise, an error code 1069910 will be returned. Otherwise, 1069910 error code will be returned'),
            file_token: zod_1.z
                .string()
                .describe('To import a file token, you need to call the  or  to get the token of the source file before creating an import task. To learn more, refer to '),
            type: zod_1.z
                .string()
                .describe('Target cloud document format. Different files support different cloud document formats. Refer to  for details. The optional values are shown below:- `docx`: new version of document- `sheet`: spreadsheet- `bitable`: multidimensional table'),
            file_name: zod_1.z
                .string()
            ...
            point: zod_1.z
                ...
                mount_type: zod_1.z
                    .number()
                    .describe('Mount type. A fixed value of 1 means that the cloud document is mounted under the cloud space. Options:1(Space Mount to My Space)'),
                mount_key: zod_1.z
                    .string()
                    .describe('The token of the folder where the cloud document is mounted, i.e., the token of the folder under the cloud space. empty indicates the cloud space root directory. To learn how to get folder tokens, refer to '),
            })
...
exports.driveV1ImportTaskGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Space-File-Import files-Query import task result-Polling the import results based on the `ticket` returned from . For details, see ',
    accessTokens: ['tenant', 'user'],
    schema: {
        path: zod_1.z.object({
            ticket: zod_1.z.string().describe('ID of the import task. Call  to get the ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.driveV1MediaUploadFinish = {
    ...
    schema: {
        data: zod_1.z.object({
            upload_id: zod_1.z
                .string()
                .describe('The ID of the block upload transaction. Obtain this by calling the [Preupload](ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_prepare) interface'),
            block_num: zod_1.z
                .number()
                .describe('The number of blocks. Obtain this by calling the [Preupload media](ssl:ttdoc/uAjLw4CM/ukTMukTMukTM/reference/drive-v1/media/upload_prepare) interface'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1MediaUploadPrepare = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Space-Media-Upload media-Upload media in blocks-Pre­uploading-Send an initialization request to obtain the upload transaction ID and shard strategy, in preparation for . The platform segments media into fixed 4MB shards. For a complete understanding of the shard upload process, refer to ',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            file_name: zod_1.z.string().describe('File name'),
            parent_type: zod_1.z
                ...
                .describe('Type of upload point. You can determine the type of upload point based on the file type and the type of cloud document. For example, to insert an image into a new document (file type `docx`), specify the upload point as `docx_image`; to upload an attachment to a new document, specify the upload point as `docx_file`. Options:doc_image(Image of a document.),docx_image(Upgraded docs image.),sheet_image(Image of a sheet.),doc_file(Doc file.),docx_file(Upgraded docs file.),sheet_file(Sheet file.),vc_virtual_background(VC virtual background (This feature is under canary release).),bitable_image(Image of a bitable.),bitable_file(Bitable file.),moments(Moments (This feature is under canary release).),ccm_import_open(File to import into Docs.)'),
            parent_node: zod_1.z
                .string()
                .describe('The token of the upload point, which is the token of the cloud document to be uploaded, used to specify the cloud document or location where the media will be uploaded. Refer to  to understand the relationship between the upload point type and the upload point token'),
            size: zod_1.z.number().describe('The size of the file, in bytes'),
            extra: zod_1.z
                .string()
                .describe('The upload points in the following scenarios need to pass the token of the cloud document where the material is located through this parameter. The format of the extra parameter is `"{\\"drive_route_token\\":\\"token of the cloud document where the material is located\\"}"`. For details, refer to ')
                .optional(),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1MetaBatchQuery = {
    ...
    httpMethod: 'POST',
    description: "[Feishu/Lark]-Docs-Space-File-Obtain Metadata-Get metadata of various Docs based on file's token, including the title, owner, create time, and more",
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            request_docs: zod_1.z
                ...
                doc_type: zod_1.z
                    ...
                    .describe('Type of the file Options:doc(Feishu Docs),sheet(Feishu Sheets),bitable(Feishu Bitable),mindnote(Feishu MindNotes),file(Feishu file),wiki(Feishu wiki),docx(Feishu Upgraded Docs),folder(Feishu folder),synced_block(SyncedBlock Feishu Synced Block (Not fully supported yet))'),
            }))
                .describe('The tokens and types of the request files. Up to 200 files are supported at a time'),
            with_url: zod_1.z.boolean().describe("Whether to get File's URL").optional(),
        }),
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('User ID type').optional() }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
...
exports.driveV1PermissionMemberAuth = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Permission-Member-Check whether the current user has a specific permission-This API is used to check whether the current login user has a specific permission on a document based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'mindnote', 'minutes', 'slides'])
                .describe('File type, which needs to match the token of the file Options:doc(Doc),sheet(Sheet),file(File in My Space),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),mindnote(Thinking Notes),minutes(Minutes),slides(Slides)'),
            action: zod_1.z
                .enum(['view', 'edit', 'share', 'comment', 'export', 'copy', 'print', 'manage_public'])
                .describe('Permission to check Options:view(view),edit(edit),share(share),comment(comment),export(export),copy(copy),print(print),manage_public(ManagePublic manage permission settings)'),
        }),
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1PermissionMemberBatchCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Permission-Member-Batch create members-This interface is used to add permissions on a document for some users based on a cloud document token',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            members: zod_1.z
...
exports.driveV1PermissionMemberCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Permission-Member-Add permissions-This API is used to add permissions on a document for a user based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            member_type: zod_1.z
                .enum(['email', 'openid', 'unionid', 'openchat', 'opendepartmentid', 'userid', 'groupid', 'wikispaceid'])
                .describe('Collaborator type, which needs to match the collaborator id Options:email(Email),openid(open_id The Open ID of the application or user. - To get the application OpenID, refer to  - Get user OpenID, refer to ),unionid(union_id Open platform unionID),openchat(open_chat Open platform chat ID),opendepartmentid(open_department_id Open platform department ID),userid(user_id User customized ID),groupid(group_id Custom user group ID),wikispaceid(wiki_space_id Wiki space ID - **NOTE**: This parameter is only supported by the wiki document, and it is required when you need to operate the "wiki space member" type collaborator in the wiki document)'),
            member_id: zod_1.z.string().describe('Collaborator ID, which needs to match the collaborator type'),
            perm: zod_1.z
                .enum(['view', 'edit', 'full_access'])
                .describe('Permission role of the collaborator Options:view(Readable role),edit(Editable role),full_access(Manageable role)'),
            perm_type: zod_1.z
                .enum(['container', 'single_page'])
                .describe("Collaborator's permission role type Options:container(Current page and its sub-pages),single_page(Current page only)")
                .optional(),
        ...
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'folder', 'mindnote', 'minutes', 'slides'])
                .describe('File type, which needs to match the token of the file Options:doc(Documentation),sheet(Spreadsheet),file(Cloud space file),wiki(Wiki node),bitable(Bitable),docx(Upgraded docs),folder(Folders (not supported for `tenant_access_token`)),mindnote(Mindnote),minutes(Minutes),slides(Slides)'),
            need_notification: zod_1.z
                .boolean()
                .describe('Specifies whether to notify the user after the permissions are added for the user.**Note:** When you use `tenant_access_token` to access the API, you cannot use this parameter')
                .optional(),
...
exports.driveV1PermissionMemberDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Docs-Permission-Member-DeletePermissionMember-This API is used to delete permissions of a document collaborator based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            type: zod_1.z
        ...
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'folder', 'mindnote', 'minutes', 'slides'])
                .describe('File type, which needs to match the token of the file Options:doc(Documentation),sheet(Spreadsheet),file(Cloud space file),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),folder(Folders (to be supported soon)),mindnote(Mindnote),minutes(Minutes),slides(Slides)'),
            member_type: zod_1.z
                .enum(['email', 'openid', 'openchat', 'opendepartmentid', 'userid', 'unionid', 'groupid', 'wikispaceid'])
                .describe('Collaborator ID type Options:email(Email),openid(Open platform ID),openchat(OpenChatID Open platform chat ID),opendepartmentid(Open platform department ID),userid(User customized ID),unionid(Open platform unionID),groupid(Custom user group ID),wikispaceid(Wiki space ID - **NOTE**: This parameter is only supported by the wiki document, and it is required when you need to operate the "wiki space member" type collaborator in the wiki document)'),
        }),
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
            member_id: zod_1.z.string().describe('Collaborator id, which needs to match the collaborator type'),
...
exports.driveV1PermissionMemberList = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/members',
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Permission-Member-Obtain a collaborator list（New version）-This API is used to query collaborators based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
            ...
            perm_type: zod_1.z
                .enum(['container', 'single_page'])
                .describe('Options:container(Current page and its sub-pages),single_page(Current page only. This parameter is only valid for wiki.)')
                .optional(),
        }),
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
...
exports.driveV1PermissionMemberTransferOwner = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Permission-Member-Transfer owner-This API is used to transfer a document owner based on file token and user information',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            member_type: zod_1.z
                .enum(['email', 'openid', 'userid'])
                .describe('Collaborator type, which needs to match the collaborator id Options:email(email),openid(open_id openid),userid(user_id userid)'),
            member_id: zod_1.z.string().describe('Collaborator id, which needs to match the collaborator type'),
        }),
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'mindnote', 'minutes', 'slides', 'folder'])
                .describe('File type, which needs to match the token of the file Options:doc(Doc),sheet(Sheet),file(File in My Space),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),mindnote(Thinking Notes),minutes(Minutes),slides(slides),folder(Folder)'),
            need_notification: zod_1.z
                .boolean()
            ...
            remove_old_owner: zod_1.z
                .boolean()
                .describe('If the value is true, the permissions of the previous owner are deleted after the owner is transferred. The default value is false')
                .optional(),
            stay_put: zod_1.z
                .boolean()
                .describe("This parameter will only take effect if the file is in a personal folder. If set to false, the system will move the content to the new owner's space. If set to true, it stays in place")
                .optional(),
            old_owner_perm: zod_1.z
                .string()
                .describe('This parameter takes effect only when remove_old_owner = false, retaining the permissions role specified by the original file owner')
                .optional(),
        }),
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
...
exports.driveV1PermissionMemberUpdate = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/members/:member_id',
    httpMethod: 'PUT',
    description: '[Feishu/Lark]-Docs-Permission-Member-UpdatePermissionMember-This API is used to update permissions of a document collaborator based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            member_type: zod_1.z
        ...
        params: zod_1.z.object({
            need_notification: zod_1.z
                .boolean()
                .describe('Specifies whether to notify the user after the permissions of the user are updated.**Note:** When you use `tenant_access_token` to access the API, you cannot use this parameter')
                .optional(),
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'mindnote', 'minutes', 'slides'])
                .describe('File type, which needs to match the token of the file Options:doc(Doc),sheet(Sheet),file(File in My Space),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),mindnote(Thinking Notes),minutes(Minutes),slides(Slides)'),
        ...
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
            member_id: zod_1.z.string().describe('Collaborator ID'),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
exports.driveV1PermissionPublicGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-Docs-Permission-Setting v1-GetPermissionPublic-This interface is used to obtain permission settings for cloud documents according to filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'mindnote', 'minutes', 'slides'])
                .describe('File type, which needs to match the token of the file Options:doc(Doc),sheet(Sheet),file(File in My Space),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),mindnote(Mindnote),minutes(Minutes),slides(slides)'),
        }),
        path: zod_1.z.object({
            token: zod_1.z.string().describe('Token of the file. For more information about how to obtain the token, see '),
        }),
...
exports.driveV1PermissionPublicPasswordCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Permission-Setting v1-password-Open password-This interface is used to enable the password of the cloud document according to the filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
                .enum(['doc', 'sheet', 'file', 'wiki', 'bitable', 'docx', 'mindnote', 'minutes', 'slides'])
                .describe('File type Options:doc(Doc),sheet(Sheet),file(File in My Space),wiki(Wiki node),bitable(Bitable),docx(Upgraded Docs),mindnote(Mindnote),minutes(Minutes(not supported)),slides(slides)'),
        }),
        path: zod_1.z.object({
            token: zod_1.z
                .string()
...
exports.driveV1PermissionPublicPasswordDelete = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public/password',
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Permission-Setting v1-password-Close password-This interface is used to disable the password of cloud doc more filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPasswordUpdate = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public/password',
    httpMethod: 'PUT',
    description: '[Feishu/Lark]-Permission-Setting v1-password-Refresh password-This interface is used to refresh the password of cloud doc more filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        params: zod_1.z.object({
            type: zod_1.z
...
exports.driveV1PermissionPublicPatch = {
    ...
    path: '/open-apis/drive/v1/permissions/:token/public',
    httpMethod: 'PATCH',
    description: '[Feishu/Lark]-Docs-Permission-Setting v1-Update document sharing settings-This API is used to update the common settings of a document based on a filetoken',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            external_access: zod_1.z.boolean().describe('Indicates whether sharing out of the tenant is allowed').optional(),
            security_entity: zod_1.z
                .enum(['anyone_can_view', 'anyone_can_edit', 'only_full_access'])
                .describe('Settings of the permission to make a copy of, print, export, and copy the document. Options:anyone_can_view(AnyoneCanView All users who can access this document.),anyone_can_edit(AnyoneCanEdit Users with the edit permission.),only_full_access(OnlyFullAccess Users with manageable privileges (including me))')
                .optional(),
            comment_entity: zod_1.z
                .enum(['anyone_can_view', 'anyone_can_edit'])
                .describe('Settings of the permission to comment on the document. Options:anyone_can_view(AnyoneCanView All users who can access this document.),anyone_can_edit(AnyoneCanEdit Users with the edit permission.)')
                .optional(),
            share_entity: zod_1.z
                .enum(['anyone', 'same_tenant', 'only_full_access'])
                .describe('Indicates who can add and manage collaborators. Options:anyone(All users who can read or edit this document.),same_tenant(SameTenant All users who can read or edit this document in the organization.),only_full_access(OnlyFullAccess Only users with full access.)')
                .optional(),
            ...
            invite_external: zod_1.z
                .boolean()
                .describe('Specifies whether users without full access and non-owners are allowed to invite external participants')
                .optional(),
        }),
        params: zod_1.z.object({
            type: zod_1.z

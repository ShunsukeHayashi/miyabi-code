...
exports.hireV2InterviewRecordGet = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-候选人管理-投递流程-面试-获取面试评价详细信息（新版）-获取面试评价详细信息，如面试结论、面试得分和面试官等信息',
...
exports.hireV2InterviewRecordList = {
    ...
    httpMethod: 'GET',
    description: '[Feishu/Lark]-候选人管理-投递流程-面试-批量获取面试评价详细信息（新版）-批量获取面试评价详细信息，如面试结论、面试得分和面试官等信息',
    accessTokens: ['tenant', 'user'],
    schema: {

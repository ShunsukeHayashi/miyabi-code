...
exports.performanceV2ActivityQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Projects-Get information about the project-Obtain project information, such as project name, project model, etc',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            semester_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('List of evaluation period IDs, get the project ID of the specified evaluation period, semester_id can be obtained by [. If "activity_ids" is passed at the same time, it is preferentially queried with "activity_ids". When "semester_ids" and "activity_ids" are not passed, empty data is returned')
                .optional(),
...
exports.performanceV2AdditionalInformationImport = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Supplementary Information-Batch Import Supplementary Information-Supplementary information of the reviewees can be imported in batches for review reference (including both new additions and updates)',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z
                .string()
                .describe('The evaluation period ID can be obtained through the [Get Period List] (/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v1/semester/list) interface'),
            additional_informations: zod_1.z
                ...
                reviewee_user_id: zod_1.z
                    .string()
                    .describe("The list of evaluee IDs, consistent with the type of imported parameter user_id_type, can be obtained through the [Get evaluee information] (/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/reviewee/query) interface< br >** Note **: If the parameter combination of reviewee_user_id ',' item ',' time ',' detailed_description 'already has a supplementary message with the same content in the system, the corresponding supplementary message data will be updated"),
                item: zod_1.z
                    .string()
...
exports.performanceV2AdditionalInformationQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Supplementary Information-Batch Query Supplementary Information-Supplementary information of the reviewees can be queried in batches',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z
...
exports.performanceV2AdditionalInformationsBatchDelete = {
    ...
    httpMethod: 'DELETE',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Supplementary Information-Batch Delete Supplementary Information-Supplementary information of the reviewees can be deleted in batches',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z.string().describe('The evaluation period ID can be obtained through the  interface'),
            additional_informations: zod_1.z
                .array(zod_1.z.string())
...
exports.performanceV2MetricDetailImport = {
    ...
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z.string().describe('Period ID, which can be obtained through the  interface'),
            import_record_name: zod_1.z
                .string()
            ...
            imported_metrics: zod_1.z
                ...
                metric_id: zod_1.z.string().describe('The indicator ID can be obtained through the  interface'),
                fields: zod_1.z
                    .array(zod_1.z.object({
                    field_id: zod_1.z.string().describe('The indicator field ID can be obtained through the  interface'),
...
exports.performanceV2MetricDetailQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z
                .string()
                .describe('Cycle ID, only 1 cycle is allowed to be queried at a time, semester_id can be obtained through the [] interface'),
            reviewee_user_ids: zod_1.z
                .array(zod_1.z.string())
...
exports.performanceV2MetricLibQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            ...
            tag_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('The label ID to which the indicator belongs can be obtained through the [[Get indicator label information](/ssl: ttdoc/uAjLw4CM/ukTMukTMukTM/performance-v2/metric_tag/list) ] interface, and all labels are not specified')
                .optional(),
            type_ids: zod_1.z
                .array(zod_1.z.string())
...
exports.performanceV2ReviewDataQuery = {
    ...
    schema: {
        data: zod_1.z.object({
            semester_ids: zod_1.z.array(zod_1.z.string()).describe('Evaluation period ID list, semester_id can be obtained through '),
...
exports.performanceV2RevieweeQuery = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Reviewee Information-Obtain information of reviewees-Obtain information of individuals selected for projects (including uninitiated projects) during the performance cycle',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({
            semester_id: zod_1.z
            ...
            activity_ids: zod_1.z
                .array(zod_1.z.string())
                .describe('The project ID list can be obtained through Interface to obtain and query the information of the evaluated person under the specified project')
                .optional(),
        }),
        params: zod_1.z.object({
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id', 'people_admin_id']).describe('User ID type').optional(),
...
exports.performanceV2UserGroupUserRelWrite = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Admin configuration-Cycles and projects-Individual Group-Write member scope of individual group-Write member scope of individual group',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({

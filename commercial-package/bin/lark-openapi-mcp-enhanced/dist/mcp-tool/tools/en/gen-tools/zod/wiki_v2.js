...
exports.wikiV2SpaceMemberCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            member_type: zod_1.z
                .string()
                .describe('"openchat" - group id "userid" - user id"email" - email "opendepartmentid" - department id"openid" - openid for application"unionid" - [unionid](/:ssltoken/home/user-identity-introduction/union-id)'),
        ...
        params: zod_1.z.object({
            need_notification: zod_1.z.boolean().describe('Whether to notify the other party after adding permissions').optional(),
        }),
        path: zod_1.z.object({ space_id: zod_1.z.string().describe('Wiki space id').optional() }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};
...
exports.wikiV2SpaceNodeCopy = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            space_id: zod_1.z.string().describe('').optional(),
...
exports.wikiV2SpaceNodeCreate = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-Docs-Wiki-node-Create node-This interface is used to create  in the wiki space at given location',
    accessTokens: ['tenant', 'user'],
    schema: {
        data: zod_1.z.object({
            obj_type: zod_1.z
...
exports.wikiV2SpaceNodeMoveDocsToWiki = {
    ...
    schema: {
        ...
        path: zod_1.z.object({
            space_id: zod_1.z.string().describe(''),
        }),
        useUAT: zod_1.z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
    },
};

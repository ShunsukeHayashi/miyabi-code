...
exports.opticalCharRecognitionV1ImageBasicRecognize = {
    ...
    httpMethod: 'POST',
    description: '[Feishu/Lark]-AI 能力-光学字符识别-识别图片中的文字-可识别图片中的文字，按图片中的区域划分，分段返回文本列表。文件大小需小于5M',
    accessTokens: ['tenant'],
    schema: {
        data: zod_1.z.object({ image: zod_1.z.string().describe('base64 后的图片数据').optional() }),
    },
};

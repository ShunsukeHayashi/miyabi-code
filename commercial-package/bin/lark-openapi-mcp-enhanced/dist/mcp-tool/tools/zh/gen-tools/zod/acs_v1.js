    ...
    schema: {
        params: zod_1.z.object({
            ...
            page_token: zod_1.z
                ...
                .optional(),
            from: zod_1.z.number().describe('记录开始时间，单位秒'),
            to: zod_1.z.number().describe('记录结束时间，单位秒，时间跨度不能超过30天'),
            device_id: zod_1.z.string().describe('门禁设备 ID').optional(),
...
exports.acsV1RuleExternalCreate = {
    ...
    schema: {
        data: zod_1.z.object({
            rule: zod_1.z
                .object({
                id: zod_1.z.string().describe('权限组id').optional(),
                name: zod_1.z.string().describe('权限组名称').optional(),
                devices: zod_1.z
                    .array(zod_1.z.object({
                    id: zod_1.z.string().describe('设备id').optional(),
                    name: zod_1.z.string().describe('设备名称').optional(),
                }))
                    .describe('权限组包含的设备')
                    .optional(),
                user_count: zod_1.z.string().describe('权限组包含的员工个数').optional(),
                users: zod_1.z
                    .array(zod_1.z.object({
                    user_type: zod_1.z
                        .number()
                    ...
                    user_name: zod_1.z.string().describe('用户名称').optional(),
                    phone_num: zod_1.z.string().describe('电话号码').optional(),
                    department_id: zod_1.z.string().describe('部门id').optional(),
                }))
                    .describe('权限组包含的员工列表')
                    .optional(),
                visitor_count: zod_1.z.string().describe('权限组包含的访客个数').optional(),
                visitors: zod_1.z
                    .array(zod_1.z.object({
                    user_type: zod_1.z
                        .number()
                    ...
                    .describe('权限组包含的访客列表')
                    .optional(),
                remind_face: zod_1.z.boolean().describe('是否通知人员录入').optional(),
                opening_time: zod_1.z
                    .object({
                    valid_day: zod_1.z
                        .object({
                        start_day: zod_1.z.number().describe('权限开始时间'),
                        end_day: zod_1.z.number().describe('权限结束时间'),
                    })
                        .describe('有效日期')
                        .optional(),
                    weekdays: zod_1.z.array(zod_1.z.number()).describe('有效星期').optional(),
                    day_times: zod_1.z
                        .array(zod_1.z.object({ start_hhmm: zod_1.z.number().describe('起始时间'), end_hhmm: zod_1.z.number().describe('结束时间') }))
                        .describe('有效时间')
                        .optional(),
                })
                    .describe('开门时间段')
                    .optional(),
                is_temp: zod_1.z.boolean().describe('是否为临时权限组').optional(),
            })
                .describe('权限组信息'),
        }),
        params: zod_1.z.object({
            rule_id: zod_1.z.string().describe('权限组id-为空创建,不为空则更新').optional(),
...
exports.acsV1RuleExternalDelete = {
    ...
    accessTokens: ['user'],
    schema: {
        params: zod_1.z.object({ rule_id: zod_1.z.string().describe('权限组id') }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.acsV1RuleExternalDeviceBind = {
    ...
    schema: {
        data: zod_1.z.object({
            device_id: zod_1.z.string().describe('设备id'),
            rule_ids: zod_1.z.array(zod_1.z.string()).describe('权限组id列表'),
        }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.acsV1RuleExternalGet = {
    ...
    schema: {
        params: zod_1.z.object({
            device_id: zod_1.z.string().describe('设备id').optional(),
            user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional(),
        }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
...
exports.acsV1UserGet = {
    ...
    accessTokens: ['tenant'],
    schema: {
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['user_id', 'union_id', 'open_id']).describe('用户ID类型').optional() }),
        path: zod_1.z.object({ user_id: zod_1.z.string().describe('用户 ID') }),
    },
};
...
exports.acsV1UserPatch = {
    ...
    schema: {
        data: zod_1.z.object({
            feature: zod_1.z
                .object({ card: zod_1.z.number().describe('卡号').optional() })
                .describe('用户特征')
                .optional(),
        }),
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['user_id', 'union_id', 'open_id']).describe('用户ID类型').optional() }),
...
exports.acsV1VisitorDelete = {
    ...
    schema: {
        params: zod_1.z.object({ user_id_type: zod_1.z.enum(['open_id', 'union_id', 'user_id']).describe('用户ID类型').optional() }),
        path: zod_1.z.object({ visitor_id: zod_1.z.string().describe('访客id') }),
        useUAT: zod_1.z.boolean().describe('使用用户身份请求, 否则使用应用身份').optional(),
    },
};
exports.acsV1Tools = [

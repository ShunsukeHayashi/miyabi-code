...
${request.contextUrls.join('\n')}`;
     ...
     */
    async iterateUI(originalCode, feedback, thinkingLevel) {
...
Use your deep thinking to understand what changes are needed and why.`;
        ...
        const response = await this.client.generateStructuredContent(iterationPrompt, responseSchema, {
...
//# sourceMappingURL=dynamic-ui-generator.js.map
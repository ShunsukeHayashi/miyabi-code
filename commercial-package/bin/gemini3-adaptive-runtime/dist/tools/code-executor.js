...
3. Provide the results and a clear explanation`;
        ...
        const response = await this.client.generateStructuredContent(fullPrompt, responseSchema, {
     ...
     */
    async analyzeCode(code, language, analysisGoals) {
...
3. Explain all changes and recommendations`;
        ...
        const response = await this.client.generateStructuredContent(analysisPrompt, responseSchema, {
            thinkingLevel: 'high',
            tools: {
                codeExecution: true,
                googleSearch: false,
...
5. Ensure good code coverage`;
        ...
        const response = await this.client.generateStructuredContent(testPrompt, responseSchema, {
            thinkingLevel: 'high',
            tools: {
                codeExecution: true,
                googleSearch: false,
     ...
     */
    async solveAlgorithm(problem, constraints, language) {
...
5. Explain the algorithm and complexity analysis`;
        ...
        const response = await this.client.generateStructuredContent(algorithmPrompt, responseSchema, {
            thinkingLevel: 'high',
            tools: {
                codeExecution: true,
                googleSearch: false,

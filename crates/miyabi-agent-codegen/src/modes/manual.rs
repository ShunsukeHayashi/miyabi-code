...
impl ManualMode {
    ...
    fn generate_execution_context(&self, task: &Task) -> Result<String> {
        ...
        let context = format!(
            r#"# 🤖 Manual Execution Context - CodeGenAgent
...
"#,
    ...
    fn print_instructions(&self, task: &Task, context_file: &Path) -> Result<()> {
        ...
        println!("\n┌────────────────────────────────────────────────────────────────┐");
        println!("│  🤖 CodeGenAgent - Manual Mode Activated                      │");
        println!("└────────────────────────────────────────────────────────────────┘\n");

        println!("📋 Issue: #{}", issue_number);
        println!("📂 Worktree: {}", self.work_dir.display());
        ...
        println!();
        println!("⏳ This agent will wait for manual completion...");

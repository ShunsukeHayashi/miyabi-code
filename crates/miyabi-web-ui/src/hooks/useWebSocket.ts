...
export interface WsEvent {
  type: 'agent_started' | 'agent_progress' | 'agent_completed' | 'task_updated' | 'agent_status' | 'log_entry' | 'issue_update' | 'pr_update' | 'deployment_update' | 'worktree_update' | 'notification';
  [key: string]: any;
}
...
// Issue #1175: New WebSocket event types

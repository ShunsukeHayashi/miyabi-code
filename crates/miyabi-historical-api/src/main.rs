//! Miyabi Historical API - Axum server for historical AI chatbot
//!
//! This server provides a REST API for chatting with historical figures
//! using RAG (Retrieval-Augmented Generation) and Claude AI.
    ...
    tracing_subscriber::registry()
        .with(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "miyabi_historical_api=info,tower_http=debug".into()),
        )

...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let test_cases = vec![
        ...
        ("Medium: API implementation", "Implement a new REST API endpoint for user authentication"),
        ...
        ("Complex: Architecture", "Design a new architecture for a distributed system with high scalability"),
        ("Complex: Refactoring", "Refactor the authentication system to improve security"),
        ("Complex: Performance", "Performance optimization for concurrent request handling"),
    ];
    ...
    println!("  OpenAI (Simple):  {} requests, {} tokens", metrics.openai_requests, metrics.openai_tokens);
    println!("  Google (Medium):  {} requests, {} tokens", metrics.google_requests, metrics.google_tokens);
    println!("  Claude (Complex): {} requests, {} tokens", metrics.claude_requests, metrics.claude_tokens);
    println!();
    println!("Total: {} requests, {} tokens", metrics.total_requests(), metrics.total_tokens());
    println!();

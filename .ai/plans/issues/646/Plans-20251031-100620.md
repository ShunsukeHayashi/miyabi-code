...
**Title**: [Phase 3.2] 初期セットアップウィザード - GitHub Token設定
...
GitHub Personal Access Tokenを設定するUIを実装する。

## 🎯 目的

ユーザーがGitHub APIにアクセスできるようにトークンを安全に設定する。
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-medium mb-2">必要な権限 (Scopes):</h3>
...
- [ ] Token入力フォームが表示される
- [ ] リアルタイムバリデーション（GitHub API確認）
- [ ] バリデーション成功時のみ次へ進める
- [ ] Tokenをセキュアに保存

## 📊 成果物

- `GitHubTokenSetup.tsx` コンポーネント
- Rustバックエンドのtoken保存機能
...
*Generated by CoordinatorAgent on 2025-10-31 10:06:20 UTC*

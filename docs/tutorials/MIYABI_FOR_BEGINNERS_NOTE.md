...
詳しいやり方は、公式ドキュメントを見てください（少し難しいけど、親御さんや先生に手伝ってもらえば大丈夫！）
...
- **GitHubリポジトリ**: [https://github.com/ShunsukeHayashi/Miyabi](https://github.com/ShunsukeHayashi/Miyabi)
- **公式ドキュメント**: GitHub上のドキュメントを参照
- **キャラクター図鑑**: 全ての仲間の詳しい説明（ポケモン図鑑風）
